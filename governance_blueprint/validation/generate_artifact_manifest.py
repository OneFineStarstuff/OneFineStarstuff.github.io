...
DEFAULT_FILES = [
    ...
    "validation/test_selftest_validate_artifacts_pytest.py",
    "validation/test_validate_artifacts_pytest.py",
    "validation/test_generate_artifact_manifest_pytest.py",
    "validation/test_make_targets_pytest.py",
