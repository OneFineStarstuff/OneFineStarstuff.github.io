...
modules.append(
    {
        ...
        "sections": [
            section(
                "M1-S1",
                "Sentinel v2.4 — Reference Topology",
                {
                    "telemetryPlane": [
            ...
            section(
                "M1-S2",
                "WorkflowAI Pro — Multi-Agent Orchestration",
                {
            ...
            section(
                "M1-S3",
                "Inference Proxy Stack — FastAPI + Node.js",
                {
            ...
            section(
                "M1-S5",
                "Sentinel ↔ WorkflowAI Pro Joint Control Loop",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M2-S4",
                "FinServ Prudential — SR 11-7, Basel III, PRA, FCA, MAS, HKMA",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M3-S4",
                "Workforce Competence (ISO 42001 Cl 7.2)",
                {
                    "trainingTracks": [
                        "Board literacy",
                        "Exec deep-dive",
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M6-S2",
                "Global Compute Registries (ICGC)",
                {
            ...
            section(
                "M6-S3",
                "Civilizational AI Governance Constitution + Codex",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M13-S2",
                "WG-02 Synthetic Deceptive Alignment",
                {
            ...
            section(
                "M13-S5",
                "WG-05 Compute Registry Evasion + WG-06 Kill-Switch Spoof",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M14-S5",
                "Treaty Annex + Supervisor Submission",
                {
                    "annexes": [
                        "A — facts",
                        "B — controls",
...
schemas = [
    ...
    {
        "id": "gacrlsRevocation",
        "fields": ["ticketId", "reason", "revokedAt", "killSwitchUrl", "pqcSig"],
    },
    {
        "id": "redTeamFinding",
        "fields": [
...
code = [
    {
        "id": "C1",
        "title": "OPA Sidecar — Rego: tool.allow with tier budget",
        "lang": "rego",
    ...
    {
        "id": "C4",
        "title": "Terraform — Zero-trust EKS module (excerpt)",
        "lang": "hcl",
    ...
    {
        "id": "C5",
        "title": "OPA Gatekeeper Constraint — Kata for Tier-1",
        "lang": "yaml",
        "snippet": 'apiVersion: constraints.gatekeeper.sh/v1beta1\nkind: K8sKataForTier1\nmetadata: { name: tier1-must-kata }\nspec:\n  match:\n    namespaceSelector:\n      matchLabels: { tier: "T1" }\n  parameters:\n    runtimeClass: "kata-clh"\n',
    },
    {
        "id": "C6",
        "title": "Kyverno Policy — Signed images only (Cosign + ML-DSA)",
        "lang": "yaml",
...
cases = [
    {
        "id": "CS-01",
        "name": "G-SIB credit & advisory across EU/UK/SG/HK",
        "outcomes": "All Tier-1 models pass SR 11-7 + EU AI Act Annex IV; fiduciary cosine ≥ 0.93; Cert score Gold by 2027; 0 SEV-0 incidents post-rollout.",
    },
    {
        "id": "CS-02",
        "name": "Frontier capital-markets agent federation (Tier-3 GACP)",
        "outcomes": "Cross-firm agents federated under GACP handshakes; revocation p95 ≤ 9 s; zero capability leakage; treaty audit pass.",
    },
    {
        "id": "CS-03",
        "name": "Fraud / AML platform with adaptive thresholds",
        "outcomes": "Recall +8 pts; SAR latency p95 -32 %; adversarial robustness held under WG-04 prompt-injection wargame.",
    },
    {
        "id": "CS-04",
        "name": "Public verifier portal w/ zk-SNARK",
        "outcomes": "Civil-society verifier sustaining 99.96 % uptime; 1.2M proofs/year; selective disclosure of drift + KPI compliance.",
    },
    {
        "id": "CS-05",
        "name": "AGI containment lab + AISI joint inspection",
        "outcomes": "12 capability evals + 4 deception probes published anonymised; 0 escape signals; ICGC quota adherence 100 %.",
    },
    {
        "id": "CS-06",
        "name": "SEV-0 post-incident reconstruction (synthetic)",
        "outcomes": "RPCO bundle assembled in 41 min; replay diff = 0; supervisor + AISI + treaty annex submitted in 4 business days.",
    },
]
...
riskControlMatrix = [
    {
        "id": "R-01",
        "threat": "Fiduciary bypass (deceptive rationale)",
        "controls": [
            "Fiduciary cosine + counterfactual",
            "Judge κ ≥ 0.9",
            "HiL for risk band",
        ],
        "kpis": ["K-04", "K-05", "K-19"],
    ...
    {
        "id": "R-02",
        "threat": "Synthetic deceptive alignment",
        "controls": ["Eval/prod resonance gap", "ASI honeypots", "AGI lab review"],
        "kpis": ["K-02", "K-03", "K-19"],
    },
    {
        "id": "R-03",
        "threat": "WORM log evasion / tamper",
        "controls": [
            "Merkle anchor + Object Lock",
            "Sequence monitor",
            "Falco rules",
            "zk no-skip proof",
        ],
    ...
    {
        "id": "R-04",
        "threat": "Prompt-injection exfil via RAG",
        "controls": [
            "Pre-prompt classifier",
            "Tool Rego deny",
            "Egress eBPF",
            "RAG taint",
        ],
    ...
    {
        "id": "R-05",
        "threat": "Compute-registry evasion",
        "controls": ["FinOps tag delta", "ICGC anomaly", "Supply-chain attestations"],
        "kpis": ["K-18"],
    },
    {
        "id": "R-06",
        "threat": "Kill-switch spoof / DoS",
        "controls": ["3-of-5 quorum", "Signed authority", "WORM trace"],
        "kpis": ["K-06", "K-07"],
    },
    {
        "id": "R-07",
        "threat": "Inference-proxy bypass",
        "controls": [
            "Cilium L7 + mTLS only",
            "Gatekeeper signed-image",
            "Egress allowlist",
        ],
        "kpis": ["K-09"],
    },
    {
        ...
        "controls": ["SLSA L3+", "Sigstore + ML-DSA-44", "Trivy/Grype gate"],
        "kpis": ["K-13"],
    },
    {
        "id": "R-09",
        "threat": "PQC KMS compromise",
        "controls": [
            "FIPS 140-3 L4 HSM",
    ...
    {
        "id": "R-10",
        "threat": "Tier-3 agent capability leak",
        "controls": [
            "GACP short-lived ticket",
            "GACRLS revocation ≤10s",
            "Containment escrow",
        ],
        "kpis": ["K-16", "K-17"],
    },
    {
        "id": "R-11",
        "threat": "Regulator unavailability of evidence",
        "controls": ["Auto Annex IV pack", "RPCO bundle", "Public zk verifier"],
        "kpis": ["K-14", "K-15", "K-22"],
    },
    {
        "id": "R-12",
        "threat": "Treaty / constitutional non-conformance",
        "controls": [
            "Constitutional kernel hooks",
            "Cert scoring",
            "Treaty annex submission",
        ],
        "kpis": ["K-24"],
    },
]
...
traceability = [
    {
        "feature": "M1 Sentinel v2.4 + WorkflowAI Pro",
        "control": "Cognitive Resonance + kill-switch + agent registry",
        "regimes": ["EU AI Act Art 14/15", "NIST RMF Measure/Manage", "ISO 42001 Cl 8"],
    },
    {
        "feature": "M2 Regulatory crosswalk",
        "control": "Article-by-article mapping + evidence index",
        "regimes": [
            "EU AI Act",
            "NIST RMF",
            "ISO 42001",
    ...
    {
        "feature": "M3 Governance pillars + roles",
        "control": "RACI + SMCR + Codex liaison",
        "regimes": ["ISO 42001 Cl 5", "SMCR", "EU AI Act Art 26"],
    },
    {
        "feature": "M4 Incident + kill-switch",
        "control": "SEV grading + quorum + hotlines",
        "regimes": ["DORA", "EU AI Act Art 73", "SR 11-7"],
    },
    {
        "feature": "M5 Sector MRM",
        "control": "Tiering + validation + replay",
        "regimes": [
            "SR 11-7",
            "PRA SS1/23",
            "MAS FEAT",
    ...
    {
        "feature": "M6 Frontier safety",
        "control": "Resonance + ICGC + Constitution + Codex + Lab",
        "regimes": ["EU AI Act Art 55", "EO 14110", "Treaty"],
    },
    {
        "feature": "M7 OPA sidecar",
        "control": "Per-call Rego decision + signed envelope",
        "regimes": ["EU AI Act Art 12/13", "GDPR Art 32"],
    },
    {
        "feature": "M8 Proxy + Kafka WORM + PQC KMS",
        "control": "Signed envelopes + Object Lock + PQC",
        "regimes": ["EU AI Act Art 12", "FIPS 203/204", "DORA"],
    },
    {
        "feature": "M9 K8s admission + CI/CD + LLM-judge",
        "control": "Gatekeeper + Cosign + judge κ",
        "regimes": ["SLSA L3+", "NIST RMF Manage", "ISO 27001"],
    },
    {
        "feature": "M10 Institutional prompting",
        "control": "Versioned library + eval harness + refusal lattice",
        "regimes": ["EU AI Act Art 13", "FCA Consumer Duty", "GDPR Art 22"],
    },
    {
        "feature": "M11 zk-SNARK + PQC proofs",
        "control": "Selective disclosure + verifier",
        "regimes": ["Treaty Annex T-1", "GDPR Art 25", "EU AI Act Art 50"],
    },
    {
        "feature": "M12 GACP/GACRLS/GACRA",
        "control": "Capability ticket + revocation + registry",
        "regimes": ["Treaty Annex T-2", "EU AI Act Art 55"],
    },
    {
        "feature": "M13 Red-team wargames",
        "control": "Scenario library + detection + containment",
        "regimes": ["NIST GAI Profile", "EO 14110", "EU AI Act Art 15"],
    },
    {
        "feature": "M14 RPCO forensics",
        "control": "Deterministic replay + chain-of-custody + annex",
        "regimes": ["DORA", "EU AI Act Art 73", "SR 11-7 supervisory exam"],
    },
]
...
dataFlows = [
    {
        ...
        "controls": ["mTLS", "Rego", "ML-DSA-44", "Object Lock"],
    },
    {
        "id": "DF-02",
        "name": "Sentinel probe loop",
        "steps": [
            "probe",
            "drift compute",
            "envelope",
        ...
        "controls": ["Probe sig", "3-of-5 quorum", "Hotline"],
    },
    {
        "id": "DF-03",
        "name": "CI/CD policy gate",
        "steps": [
            "pre-commit",
            "PR judge LLM",
            "SBOM + scan",
        ...
        "controls": ["Judge κ", "SLSA L3+", "Gatekeeper"],
    },
    {
        "id": "DF-04",
        "name": "GACP handshake + revocation",
        "steps": [
            "attest",
            "negotiate",
            "zk constraint",
        ...
        "controls": ["PQC", "zk-SNARK", "≤10s revoke"],
    },
    {
        "id": "DF-05",
        "name": "zk-SNARK proof publication",
        "steps": [
            "witness from WORM",
            "prove",
            "sign",
        ...
        "controls": ["MPC trusted setup", "ML-DSA-65", "Verifier uptime"],
    },
    {
        "id": "DF-06",
        "name": "RPCO post-incident",
        "steps": ["detect", "preserve", "replay", "diff=0", "RCA", "annexes", "submit"],
        "controls": ["WORM", "Replay harness", "PAdES+PQC"],
    },
]
...
regulators = [
    {
        "id": "REG-01",
        "name": "EU Commission AI Office + EU AISI",
        "primary": "EU AI Act + frontier safety",
    },
    {
        "id": "REG-02",
        "name": "ECB-SSM + EBA + ESMA",
        "primary": "EU prudential + markets",
    },
    {"id": "REG-03", "name": "PRA + Bank of England", "primary": "UK prudential"},
    {"id": "REG-04", "name": "FCA", "primary": "UK conduct + Consumer Duty + SMCR"},
    {
        "id": "REG-05",
        "name": "FRB + OCC + FDIC + CFPB",
        "primary": "US prudential + consumer",
    },
    {
        "id": "REG-06",
        "name": "SEC + CFTC + FINRA",
        "primary": "US markets + broker-dealer",
    },
    {
        "id": "REG-07",
        "name": "MAS",
        "primary": "Singapore prudential + FEAT + AI Verify",
    },
    {"id": "REG-08", "name": "HKMA + SFC", "primary": "Hong Kong"},
    {"id": "REG-09", "name": "BoJ + FSA Japan", "primary": "Japan"},
    {
        "id": "REG-10",
        "name": "AISI (US, UK, EU, SG, JP)",
        "primary": "Frontier model safety",
    },
    {
        "id": "REG-11",
    ...
    {
        "id": "REG-12",
        "name": "Treaty Secretariat + OECD + FSB + BIS",
        "primary": "Global civilizational",
    },
]
...
workshops = [
    {
        ...
        "duration": "2 h",
        "outcome": "Sign off architecture risk appetite + Cert score plan + Codex acknowledgement",
    },
    {
        "id": "WS-02",
        "audience": "C-Suite + SMFs",
        "duration": "1 d",
        "outcome": "Operating model + SMCR statements + escalation drill",
    },
    {
        "id": "WS-03",
        "audience": "MRM + 2LoD",
        "duration": "2 d",
        "outcome": "Sector MRM playbooks + replay + effective challenge",
    },
    {
        "id": "WS-04",
        "audience": "Platform Eng + EA + Security",
        "duration": "2 d",
        "outcome": "OPA sidecar + proxy + Kafka WORM + PQC KMS bootcamp",
    },
    {
        "id": "WS-05",
        "audience": "AI Safety + SOC + IR",
        "duration": "1 d",
        "outcome": "Sentinel + kill-switch drill + RPCO walkthrough",
    },
    {
        "id": "WS-06",
        "audience": "Red team + 3LoD",
        "duration": "1 d",
        "outcome": "Run WG-01..WG-06 wargames + supervisor share template",
    },
    {
        "id": "WS-07",
        "audience": "Treaty Liaison + AISI + Supervisor",
        "duration": "1 d",
        "outcome": "GACP/GACRLS/GACRA handshake + zk-SNARK verifier + Annex submission",
    },
]
...
rollout90 = [
    ...
    {
        "day": "61-90",
        "track": "Federation + Civilizational",
        "items": [
...
roadmap = [
    {
        "year": "2026",
        "focus": "Architecture + Sector MRM + Kill-switch",
        "milestones": [
    ...
    {
        "year": "2027",
        "focus": "Federation + Public Verifier",
        "milestones": [
