...
DOC["directive"] = {
    ...
    "parsed": {
        ...
        "reports": [
            {
                "id": "R1",
                "title": "Navigating the Complexities of AI Safety and Global Governance",
            },
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M3-S5",
                "OPA Policy Plane + Terraform Golden Envs + CI/CD",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M4-S3",
                "Trading Agent (AlphaTrade-V9 pattern)",
                {
                    "checks": [
                        "latent drift",
                        "reward hacking",
            ...
            section(
                "M4-S5",
                "CRS-UUID-001 — Canonical Credit Risk System",
                {
                    "id": "CRS-UUID-001",
                    "tier": "T1",
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M5-S5",
                "Minimum Viable AGI Governance Stack (MVAGS)",
                {
                    "components": [
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M7-S3",
                "WorkflowAI Pro — Prompt Management",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M8-S2",
                "Structured Output + Retrieval + Tool Use",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M11-S3",
                "Terraform Golden Envs + Kafka ACL + WORM + PQC",
                {
            ...
            section(
                "M11-S4",
                "Replay + Drift + Red Team + Cognitive Resonance",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M12-S5",
                "Re-classification + Frontier Escalation",
                {
                    "triggers": [
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M13-S3",
                "Day 61-90 — Hardening + MVAGS Production",
                {
                    "items": [
...
modules.append(
    {
        ...
        "sections": [
            section(
                "M14-S1",
                "2026 — MVAGS + Coalition Activation",
                {
                    "milestones": [
            ...
            section(
                "M14-S2",
                "2027 — Frontier Containment + GAIVS Passport",
                {
                    "milestones": [
            ...
            section(
                "M14-S3",
                "2028 — PQC + AI Capital Buffer + Treaty Interop",
                {
                    "milestones": [
            ...
            section(
                "M14-S4",
                "2029-2030 — Civilizational-Grade Operations",
                {
                    "milestones2029": [
...
schemas = [
    ...
    },
    {
        ...
        "fields": [
            ...
            "lastValidationRef",
            "aiBomRef",
            "cognitiveResonanceState",
        ],
    },
    {
        "id": "regulatorPackBundle",
        "fields": [
            "packId",
            "regime",
            "modelId",
    ...
    {
        "id": "coalitionPartnerRecord",
        "fields": ["partnerId", "name", "scope", "obligations", "signers", "anchorRef"],
    },
]
...
code = [
    {
        "id": "CE-01",
        "title": "GitHub Actions — Sigstore + ML-DSA-44 + OPA gate",
        "lang": "yaml",
...
cases = [
    {
        "id": "CS-01",
        "name": "Tier-1 G-SIB — MVAGS Day-90 production",
        "outcomes": "All Tier-1 covered; Annex IV pack 26 min p95; kill-switch p95 53 s; Cognitive Resonance 0 unmitigated breaches in 30 d",
    },
    {
        "id": "CS-02",
        "name": "CRS-UUID-001 — cross-jurisdiction credit",
        "outcomes": "Disparate impact ≤ 0.04; ECOA + FCA + MAS evidence signed; supervisor sign-off month 3",
    },
    {
        "id": "CS-03",
        "name": "AlphaTrade-V9 tabletop — board exercise",
        "outcomes": "Kill-switch p95 53 s; regulator-notify draft 90 min; comms clarity 4.6/5; Cognitive Resonance breach contained",
    },
    {
        "id": "CS-04",
        "name": "AI Safety Report Generator R1..R4",
        "outcomes": "All four reports auto-generated in 22 min p95; PAdES + ML-DSA-65 signed; submitted to lead supervisor",
    },
    {
        "id": "CS-05",
        "name": "Coalition Activation Year-1",
        "outcomes": "5 partner institutions signed; 3 jurisdictions covered; GAID + GAI-SOC feeds bidirectional",
    },
    {
        "id": "CS-06",
        "name": "ASI honeypot pilot",
        "outcomes": "3 SEV-0 candidates captured in 6 months; 0 production reach; full forensic capture",
    },
]
...
kpis = [
    ...
    {
        "id": "KPI-15",
        "name": "Sigstore + ML-DSA-44 coverage Tier-1",
    ...
    {
        "id": "KPI-19",
        "name": "Honeypot SEV-0 escalation",
        "target": "100 % within 5 min",
    },
    {
        "id": "KPI-20",
        "name": "AI capital buffer attestation (GFMCF)",
        "target": "Quarterly 100 %",
    },
    {
        "id": "KPI-21",
        "name": "Crisis simulation cadence",
        "target": "≥ semi-annual board-level",
    },
    {
        "id": "KPI-22",
        "name": "Consortia attestations live (ICGC+GACRA+GASO+GAI-SOC)",
        "target": "100 % monthly",
    },
    {
        "id": "KPI-23",
        "name": "Board literacy score",
...
riskControlMatrix = [
    ...
    {
        "id": "RC-02",
        "threat": "Insecure output handling (LLM02)",
        "controls": ["allow-list validators", "WORM-logged outputs", "judge ensemble"],
        "kpis": ["KPI-01"],
    },
    {
        "id": "RC-03",
        "threat": "Training data poisoning (LLM03)",
        "controls": [
            "AI BoM dataset lineage",
            "Sigstore",
            "FL gradient anomaly z ≥ 3.5",
        ],
        "kpis": ["KPI-17", "KPI-22"],
    },
    {
        "id": "RC-04",
        "threat": "Supply chain compromise (LLM05)",
        "controls": ["SLSA L3+", "Sigstore + ML-DSA-44", "in-toto"],
        "kpis": ["KPI-15"],
    },
    {
        "id": "RC-05",
        "threat": "Sensitive info disclosure (LLM06)",
        "controls": ["DLP", "eBPF redaction", "RAG ACL", "zk-SNARK auditor access"],
        "kpis": ["KPI-01"],
    },
    {
        "id": "RC-06",
        "threat": "Excessive agency (LLM08)",
        "controls": ["multisig kill-switch", "tool allow-list", "honeypot"],
        "kpis": ["KPI-02", "KPI-19"],
    },
    {
        "id": "RC-07",
        "threat": "Model drift / fairness regression",
        "controls": ["Cognitive Resonance", "PSI/KS drift", "fairness audit"],
        "kpis": ["KPI-11", "KPI-12", "KPI-13"],
    },
    {
        "id": "RC-08",
        "threat": "Deceptive alignment (frontier)",
        "controls": [
            "Cognitive Resonance",
            "ASI honeypot",
            "swarm consensus",
    ...
    {
        "id": "RC-09",
        "threat": "Cross-border data leakage",
        "controls": [
            "FL secure aggregation",
            "per-region keys",
            "SCCs",
            "Terraform residency tags",
        ],
        "kpis": ["KPI-01"],
    },
    {
        ...
        "controls": ["Object Lock", "daily Merkle", "PQC signing", "public verifier"],
        "kpis": ["KPI-14", "KPI-24"],
    },
    {
        "id": "RC-11",
        "threat": "Excess capital under-provision",
        "controls": ["GFMCF AI capital buffer", "stress test", "Pillar 3 disclosure"],
        "kpis": ["KPI-20"],
    },
    {
        "id": "RC-12",
        "threat": "Inadequate board oversight",
        "controls": [
            "Board AI/Risk Cmte charter",
            "literacy programme",
...
traceability = [
    {
        "feature": "M1 7-pillar model",
        "control": "Charters + RACI + SMCR named SMF",
        "regimes": ["ISO 42001 Cl 5", "SMCR", "SR 11-7"],
    },
    {
        "feature": "M2 EU AI Act crosswalk",
        "control": "Article-level evidence matrix + auto pack",
        "regimes": ["EU AI Act Arts 9-72 + Annex IV"],
    },
    {
        "feature": "M3 Kafka WORM + ACL",
        "control": "SASL/SCRAM + mTLS + Object Lock + Merkle + PQC",
        "regimes": ["EU AI Act Art 12", "DORA", "GDPR Art 32"],
    },
    {
        "feature": "M4 CRS-UUID-001",
        "control": "ECOA + FCRA + FCA + MAS evidence + AI BoM",
        "regimes": ["FCRA §615(a)", "ECOA Reg B", "FCA Consumer Duty", "MAS FEAT"],
    },
    {
        "feature": "M5 Cognitive Resonance",
        "control": "Δ_drift ≤ 4 %, latent ≤ 3 %, cosine ≥ 0.92",
        "regimes": ["EU AI Act Art 15", "NIST GAI Profile"],
    },
    {
        "feature": "M6 Consortia attestations",
        "control": "ICGC + GACRA + GASO + GAI-SOC feeds signed",
        "regimes": ["GAIGA", "FSB AI", "OECD"],
    },
    {
        "feature": "M7 Hub + Report Gen + WorkflowAI Pro",
        "control": "WebAuthn + RBAC + signed runs",
        "regimes": ["ISO 27001", "WCAG 2.2"],
    },
    {
        "feature": "M8 Prompt engineering lifecycle",
        "control": "Author + reviewer + approver Ed25519 + ML-DSA-44 sign",
        "regimes": ["ISO 42001 Cl 8", "NIST RMF Manage"],
    },
    {
        "feature": "M9 Civilizational corpus",
        "control": "Constitution + Operating Model + Coalition Activation",
        "regimes": ["OECD AI Principles", "Council of Europe AI Convention"],
    },
    {
        "feature": "M10 R1..R4 reports",
        "control": "<title>/<abstract>/<content> + PAdES + ML-DSA-65",
        "regimes": ["EU AI Act Art 13", "SR 11-7", "PRA SS1/23"],
    },
    {
        "feature": "M11 Implementation blueprints",
        "control": "CI/CD + OPA + Terraform + replay + drift + red-team",
        "regimes": ["SLSA L3+", "Sigstore", "FIPS 204"],
    },
    {
        "feature": "M12 Tier T1-T3",
        "control": "Controls + evidence + cadence by tier",
        "regimes": ["SR 11-7 tiering", "PRA SS1/23"],
    },
    {
        "feature": "M13 30/60/90 plan",
        "control": "MVAGS Day-90 production with sign-off",
        "regimes": ["EU AI Act Art 9 RMS", "ISO 42001 Cl 9"],
    },
    {
        "feature": "M14 2026-2030 roadmap + artifacts",
        "control": "Per-audience machine-readable artifacts",
        "regimes": ["NIST RMF", "GAIGA", "GATI"],
    },
]
...
dataFlows = [
    {
        ...
        "controls": ["WebAuthn", "Ed25519 + ML-DSA-44", "Object Lock"],
    },
    {
        "id": "DF-02",
        "name": "Inference → WORM → replay → R2 report",
        "steps": [
        ...
        "controls": ["mTLS", "PQC", "deterministic seed", "PAdES"],
    },
    {
        "id": "DF-03",
        "name": "Cognitive Resonance breach → IR",
        "steps": [
        ...
        "controls": ["≤ 60 s logical", "≤ 5 min physical"],
    },
    {
        "id": "DF-04",
        "name": "Annex IV pack auto-assembly",
        "steps": [
            "collect evidence",
            "section mapping",
            "judge tone",
        ...
        "controls": ["≤ 30 min", "0 critical errors"],
    },
    {
        "id": "DF-05",
        "name": "Consortia attestation",
        "steps": [
            "compute metrics",
            "sign with ML-DSA-65",
        ...
        "controls": ["monthly cadence", "PQC"],
    },
    {
        "id": "DF-06",
        "name": "Public verifier proof",
        "steps": [
            "read anchor",
        ...
        "controls": ["uptime ≥ 99.95 %", "no PII leakage"],
    },
]
...
regulators = [
    ...
    {
        "id": "REG-11",
        "name": "OSFI + OPC Canada",
        "primary": "Canada prudential + privacy",
    },
    {
        "id": "REG-12",
        "name": "FSB + BIS + IMF + OECD + AISI (US/UK)",
        "primary": "Global + treaty",
    },
]
...
workshops = [
    {
        ...
        "duration": "2 h",
        "outcome": "Risk appetite + tabletop sign-off + Closing Charge ratification",
    },
    {
        "id": "WS-02",
        "audience": "C-Suite + SMFs",
        "duration": "1 d",
        "outcome": "Operating model + SMCR responsibilities map",
    },
    {
        "id": "WS-03",
        "audience": "MRM + AI Risk + 2LoD",
        "duration": "1 d",
        "outcome": "Sector MRM playbook (credit, trading, fiduciary, CRS-UUID-001)",
    },
    {
        "id": "WS-04",
        "audience": "Platform Engineering + Enterprise Architecture",
        "duration": "2 d",
        "outcome": "K8s + Kafka WORM + OPA + Terraform bootcamp",
    },
    {
        "id": "WS-05",
        "audience": "SOC + IR + AI Safety Lead",
        "duration": "1 d",
        "outcome": "SEV-0..SEV-3 runbook + ASI honeypot drill",
    },
    {
        "id": "WS-06",
        "audience": "Internal Audit (3LoD)",
        "duration": "1 d",
        "outcome": "Replay + WORM verifier inspection + report R1..R4 walkthrough",
    },
    {
        "id": "WS-07",
        "audience": "Supervisor + AISI liaison",
        "duration": "0.5 d",
        "outcome": "Annex IV + SR 11-7 + R1..R4 demo + GAP attestation walkthrough",
    },
]
...
roadmap = [
    {
        "year": "2026",
        "focus": "MVAGS Day-90 + Coalition Activation",
        "milestones": [
    ...
    {
        "year": "2027",
        "focus": "Frontier Containment + GAIVS Passport",
        "milestones": [
    ...
    {
        "year": "2028",
        "focus": "PQC + AI Capital Buffer + Treaty Interop",
        "milestones": [
    ...
    {
        "year": "2029",
        "focus": "Civilizational-Grade Operations",
        "milestones": [
