#!/usr/bin/env python3
"""
WP-040 — HTML dashboard renderer for the Enterprise AGI/ASI Governance Master
...
SRC = ROOT / "data" / "ent-agi-ref-impl.json"
...
h1{{margin:0 0 8px 0;font-size:1.85rem}}
...
<div class="container">
  ...
  <div class="badges" style="margin-top:8px">
    ...
    <span class="badge">US EO 14110</span>
...
<h2>Builds On (Workpackage Lineage)</h2>
<ul>{builds_html}</ul>
...
Builds on WP-035 + WP-036 + WP-037 + WP-038 + WP-039
</footer>
