...
DOC["directive"] = {
    ...
    "parsed": {
        ...
        "treaty": {
            "windowYears": "2026-2035",
            "signatories": ["G20", "EU", "UK", "SG", "JP", "CH"],
        },
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M1-S5",
                "Clauses 9 & 10 — Performance Evaluation + Improvement; Clause-Mapped Control Catalog",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M2-S5",
                "Ongoing Monitoring + Outcome Analysis + Retirement",
                {
...
modules.append(
    {
        ...
        "sections": [
            section(
                "M3-S1",
                "Terraform Golden Envs + IaC Signing",
                {
                    "envs": [
                        "sandbox",
                        "dev",
            ...
            section(
                "M3-S3",
                "Kafka WORM + PQC + CRS-UUID Lineage",
                {
            ...
            section(
                "M3-S4",
                "CI/CD Governance Gates + Deterministic Replay",
                {
                    "ciGates": [
                        "SBOM + AI BoM",
                        "OPA bundle test",
            ...
            section(
                "M3-S5",
                "Cognitive Resonance + AGI/ASI Exposure + Containment",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M5-S3",
                "Deceptive Alignment + ASI Honeypot",
                {
                    "indicators": [
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M8-S3",
                "Global AI Governance Constitution",
                {
            ...
            section(
                "M8-S4",
                "Civilizational Governance Codex (CGC)",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M11-S3",
                "Existential Coordination System",
                {
            ...
            section(
                "M11-S5",
                "Integration with Codex + Constitution",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M14-S3",
                "2027-2028 — Treaty Onboarding + UMIF GA",
                {
                    "2027": [
            ...
            section(
                "M14-S4",
                "2029-2030 — Civilizational Steady-State",
                {
                    "2029": [
                        "Cert Platinum",
            ...
            section(
                "M14-S5",
                "Regulator/Auditor Evidence Pack Generator",
                {
                    "inputs": [
...
schemas = [
    ...
    {
        "id": "crsUuidLineageEdge",
        "fields": ["edgeId", "src", "dst", "edgeType", "ts", "signer", "signature"],
    },
    {
        "id": "sraseInspectionReport",
        "fields": [
            "reportId",
            "persona",
            "workflow",
    ...
    {
        "id": "treatyObligationAttestation",
        "fields": ["attestId", "obligation", "ts", "metrics", "signer", "anchorRef"],
    },
    {
        "id": "globalAuditApiReceipt",
        "fields": [
            "receiptId",
            "supervisor",
            "endpoint",
...
code = [
    {
        "id": "CE-01",
        "title": "ISO 42001 Clause 6.1 — Risk register row (JSON)",
        "lang": "json",
...
cases = [
    {
        "id": "CS-01",
        "name": "ISO 42001 Stage 2 audit — G-SIB",
        "outcomes": "0 major NCs; 3 minor; Cert score Gold; AIMS Manual + Annex A fully evidenced",
    },
    {
        "id": "CS-02",
        "name": "MRM platform rollout for Tier-1 trading + credit",
        "outcomes": "200 models in CRS-UUID lineage; replay byte-identical ≥ 99.9 %; Cognitive Resonance breaches 0 unmitigated in 90 d",
    },
    {
        "id": "CS-03",
        "name": "SRASE pre-flight before AISI inspection",
        "outcomes": "Composite 0.94; 6 gaps auto-CAPA closed pre-submission; AISI inspection passed",
    },
    {
        "id": "CS-04",
        "name": "Sentinel AGI Lab — deceptive-alignment indicator",
        "outcomes": "Indicator detected within 12 h; air-gap containment + AISI joint review; published anonymised report via GAID",
    },
    {
        "id": "CS-05",
        "name": "Treaty obligation onboarding (GIEN + Global Audit API)",
        "outcomes": "12 supervisor consumers onboarded; 100 % obligation attestations green for 4 quarters",
    },
    {
        "id": "CS-06",
        "name": "MGK adversarial break harness",
        "outcomes": "12 500 attacks/release; 0 failures on RC3; v1 promoted to Tier-1 production",
    },
]
...
kpis = [
    ...
    {
        "id": "KPI-02",
        "name": "Annex A control evidence completeness",
        "target": "≥ 98 %",
    },
    {
        "id": "KPI-03",
        "name": "Model Risk Policy adherence (T1 audits)",
        "target": "100 %",
    },
    {
        "id": "KPI-04",
        "name": "Effective challenge coverage T1",
        "target": "100 % annually",
    },
    {"id": "KPI-05", "name": "CRS-UUID lineage coverage", "target": "≥ 99 % artifacts"},
    {
        "id": "KPI-06",
        "name": "Deterministic replay byte-identical",
        "target": "≥ 99.9 %",
    },
    ...
    {
        "id": "KPI-17",
        "name": "MGK formal proof coverage",
        "target": "≥ 95 % safety-critical",
    },
    {"id": "KPI-18", "name": "MGK break-harness failures per release", "target": "0"},
    {
        "id": "KPI-19",
        "name": "Treaty obligation attestations green",
        "target": "100 % monthly",
    },
    {
        "id": "KPI-20",
        "name": "Cert score level",
        "target": "Gold by 2027; Platinum by 2029",
    },
    {"id": "KPI-21", "name": "Public verifier uptime", "target": "≥ 99.95 %"},
    {
        "id": "KPI-22",
        "name": "Global Audit API supervisor satisfaction",
        "target": "≥ 4.5/5",
    },
    {
        "id": "KPI-23",
        "name": "Constitutional principle conformance",
        "target": "100 % articles attested",
    },
    {
        "id": "KPI-24",
        "name": "Board AI literacy",
        "target": "≥ 90 % by 2027; 95 % by 2030",
    },
]
...
riskControlMatrix = [
    {
        "id": "RC-01",
        "threat": "AIMS Cl 6.1 risk register incomplete",
        "controls": ["Mandatory CRD-backed register", "Quarterly internal audit"],
        "kpis": ["KPI-02"],
    },
    {
        "id": "RC-02",
        "threat": "Tier misclassification of high-impact model",
        "controls": ["Independent MRM tiering", "Effective challenge"],
        "kpis": ["KPI-03", "KPI-04"],
    },
    {
        "id": "RC-03",
        "threat": "CRS-UUID lineage gap",
        "controls": ["Sidecar auto-emit", "WORM verifier audit"],
        "kpis": ["KPI-05"],
    },
    {
        "id": "RC-04",
        "threat": "Replay non-determinism",
        "controls": ["Frozen kernels", "Seed envelope", "Replay engine SLO"],
        "kpis": ["KPI-06"],
    },
    {
        "id": "RC-05",
        "threat": "Cognitive Resonance unmitigated breach",
        "controls": ["Auto kill-switch", "SEV-1 escalation"],
        "kpis": ["KPI-07", "KPI-08"],
    },
    {
        "id": "RC-06",
        "threat": "Annex IV pack assembly miss SLA",
        "controls": ["Pre-built section mapper", "SRASE pre-flight"],
        "kpis": ["KPI-10", "KPI-12"],
    },
    {
        "id": "RC-07",
        "threat": "Frontier deceptive alignment",
        "controls": ["Sentinel AGI Lab", "ASI honeypot", "AISI inspection"],
        "kpis": ["KPI-13"],
    },
    {
        "id": "RC-08",
        "threat": "Treaty obligation breach",
        "controls": ["GIEN feeds", "Global Audit API", "Cert score gate"],
        "kpis": ["KPI-19", "KPI-20"],
    },
    {
        "id": "RC-09",
        "threat": "MGK regression in release",
        "controls": ["≥ 10 000 attack harness", "Proof coverage gate"],
        "kpis": ["KPI-17", "KPI-18"],
    },
    {
        "id": "RC-10",
        "threat": "Public verifier downtime",
        "controls": ["Multi-region active-active", "IPFS mirroring"],
        "kpis": ["KPI-21"],
    },
    {
        "id": "RC-11",
        "threat": "Sanction misapplication",
        "controls": ["Dual-control on G5/G6", "Appeal route + tribunal"],
        "kpis": ["KPI-22"],
    },
    {
        "id": "RC-12",
        "threat": "Constitutional article drift",
        "controls": ["Codex review semi-annual", "2/3 amendment threshold"],
        "kpis": ["KPI-23"],
    },
]
...
traceability = [
    {
        "feature": "M1 AIMS Manual Cl 4-10",
        "control": "Annex A controls + clause-mapped catalog",
        "regimes": ["ISO 42001 Cl 4-10", "EU AI Act Annex IV", "NIST RMF Govern"],
    },
    {
        "feature": "M2 Model Risk Policy",
        "control": "Tiering + validation + effective challenge",
        "regimes": ["SR 11-7", "PRA SS1/23", "MAS FEAT", "HKMA GL-90"],
    },
    {
        "feature": "M3 MRM Platform (Terraform+K8s+Kafka+OPA+WORM+Replay)",
        "control": "Signed envelopes + CRS-UUID lineage + replay",
        "regimes": ["EU AI Act Art 12", "DORA", "GDPR Art 32"],
    },
    {
        "feature": "M4 SRASE",
        "control": "Pre-flight regulator simulation",
        "regimes": ["EU AI Act Art 73", "SR 11-7 supervisory exam"],
    },
    {
        "feature": "M5 Sentinel AGI Lab + Red-Team",
        "control": "Air-gap + AISI + 95 % attack coverage",
        "regimes": ["EU AI Act Art 55", "NIST GAI Profile"],
    },
    {
        "feature": "M6 Treaty 2026-2035",
        "control": "Framework + Annexes + Protocols + Dispute Resolution",
        "regimes": ["Council of Europe AI Convention", "G7 Hiroshima", "OECD"],
    },
    {
        "feature": "M7 Global Audit API + Cert + GIEN",
        "control": "Treaty-mandated read endpoints + scoring + telemetry",
        "regimes": ["Treaty Annex T-1", "FSB AI"],
    },
    {
        "feature": "M8 Auto Sanctions + Constitution + Codex",
        "control": "OPA + dual-control + appeal",
        "regimes": ["Treaty Annex T-3", "Constitution Arts 1-7"],
    },
    {
        "feature": "M9 Transparency Portal + Cultural Resonance + CSE-X",
        "control": "Verifier + multilingual + scenarios",
        "regimes": ["EU AI Act Art 50", "ISO 42001 Cl 7.4"],
    },
    {
        "feature": "M10 Invariance + Meta-Invariance",
        "control": "Coq + TLA+ + Z3 + OPA",
        "regimes": ["NIST RMF Manage", "Constitution Art 2"],
    },
    {
        "feature": "M11 Epistemic + Ontological + Existential + Value",
        "control": "Alignment systems + GIEN drills",
        "regimes": ["UNESCO AI Ethics", "OECD AI Principles"],
    },
    {
        "feature": "M12 UMIF + Self-Proving + Policy DSL",
        "control": "Compositional refinement L1→L4 + PCR/PCO",
        "regimes": ["ISO 42001 Cl 10", "Constitution Art 3"],
    },
    {
        "feature": "M13 MGK + Adversarial Break Harness",
        "control": "Minimal verified kernel + 10 000 attacks",
        "regimes": ["EU AI Act Art 15", "SLSA L3+", "FIPS 204"],
    },
    {
        "feature": "M14 Operating Model + Evidence Pack",
        "control": "Per-lane lineage + auto pack ≤ 45 min",
        "regimes": ["ISO 42001", "EU AI Act Annex IV", "SR 11-7", "Treaty"],
    },
]
...
dataFlows = [
    {
        ...
        "controls": ["WORM evidence", "Signed minutes"],
    },
    {
        "id": "DF-02",
        "name": "Model lifecycle → CRS-UUID → Replay",
        "steps": [
            "dataset register",
            "model build",
            "validation",
        ...
        "controls": ["Sigstore", "ML-DSA-44", "deterministic seed"],
    },
    {
        "id": "DF-03",
        "name": "SRASE pre-flight → real submission",
        "steps": [
            "assemble pack",
            "SRASE personas",
            "composite score",
        ...
        "controls": ["≥ 0.9 gate", "Signed pack"],
    },
    {
        "id": "DF-04",
        "name": "Sentinel Lab → AISI joint review",
        "steps": [
            "experiment",
            "indicators",
            "containment",
        ...
        "controls": ["Air-gap", "Dual-control", "GAID format"],
    },
    {
        "id": "DF-05",
        "name": "GIEN streaming + Global Audit API",
        "steps": [
            "firm emit GIEN",
        ...
        "controls": ["mTLS", "zk-SNARK", "ML-DSA-65"],
    },
    {
        "id": "DF-06",
        "name": "UMIF policy → MGK runtime",
        "steps": [
            "DSL author",
        ...
        "controls": ["Proof coverage ≥ 0.95", "Break harness 0 failures"],
    },
]
...
regulators = [
    {
        "id": "REG-01",
        "name": "EU Commission AI Office + AISI EU",
        "primary": "EU AI Act lead + safety institute",
    },
    {
        "id": "REG-02",
        "name": "ECB-SSM + EBA + ESMA",
        "primary": "EU prudential + securities",
    },
    ...
    {
        "id": "REG-11",
        "name": "ISO 42001 certification body",
        "primary": "AIMS certification",
    },
    {
        "id": "REG-12",
        "name": "Treaty Secretariat + UN + BIS + OECD + AISI",
        "primary": "Global treaty + civilizational",
    },
]
...
workshops = [
    {
        "id": "WS-01",
        "audience": "Board AI/Risk Cmte",
        "duration": "2 h",
        "outcome": "ISO 42001 management review + Cert score sign-off + Codex ratification",
    },
    {
        "id": "WS-02",
        "audience": "C-Suite + SMFs",
        "duration": "1 d",
        "outcome": "Operating Model walkthrough + SMCR statements",
    },
    {
        "id": "WS-03",
        "audience": "MRM + AI Risk + 2LoD",
        "duration": "2 d",
        "outcome": "Model Risk Policy + MRM platform bootcamp",
    },
    {
        "id": "WS-04",
        "audience": "Platform + EA + Security",
        "duration": "2 d",
        "outcome": "MRM platform + MGK + UMIF rollout",
    },
    {
        "id": "WS-05",
        "audience": "SOC + IR + AI Safety",
        "duration": "1 d",
        "outcome": "Sentinel AGI Lab + SRASE drill",
    },
    {
        "id": "WS-06",
        "audience": "Internal Audit (3LoD)",
        "duration": "1 d",
        "outcome": "Annex A controls + replay + harness inspection",
    },
    {
        "id": "WS-07",
        "audience": "Treaty Liaison + Supervisor + AISI",
        "duration": "1 d",
        "outcome": "GIEN + Global Audit API + Cert + sanctions walkthrough",
    },
]
...
rollout90 = [
    ...
    {
        "day": "61-90",
        "track": "Civilizational + Treaty + Cert",
        "items": [
            "GIEN ingress/egress live",
            "Global Audit API consumer onboarded",
...
roadmap = [
    {
        "year": "2026",
        "focus": "AIMS + MRM + Sentinel Lab + SRASE + MGK v1",
        "milestones": [
    ...
    {
        "year": "2027",
        "focus": "UMIF GA + Treaty Onboarding",
        "milestones": [
            "UMIF Operator GA",
    ...
    {
        "year": "2028",
        "focus": "Civilizational Codex + Transparency v2",
        "milestones": [
            "Treaty obligations fully met",
            "Codex v1 ratified",
    ...
    {
        "year": "2029",
        "focus": "Civilizational Steady-State",
        "milestones": [
            "Cert Platinum",
            "MGK formal proof coverage ≥ 0.97",
            "Existential Coordination drills with 5+ signatories",
    ...
    {
        "year": "2030",
        "focus": "Treaty Maturity + Constitutional Review",
        "milestones": [
