...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M1-S3",
                "Civilizational Codex — 12 Axioms (excerpt)",
                [
            ...
            section(
                "M1-S5",
                "Why a Codex Layer is Necessary",
                [
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M2-S5",
                "Example LexAI-DSL Clause (excerpt)",
                [
...
modules.append(
    {
        ...
        "sections": [
            section(
                "M4-S1",
                "GASRGP — Global AI Systemic Risk Governance Protocol",
                {
            ...
            section(
                "M4-S2",
                "GASC — Global AI Safety Convention",
                {
            ...
            section(
                "M4-S3",
                "GAISM — Global AI Stability Mechanism",
                {
            ...
            section(
                "M4-S5",
                "Pilot Treaties & Sunrise Clauses",
                [
...
modules.append(
    {
        ...
        "sections": [
            section(
                "M7-S1",
                "Briefing Deck Templates (sample)",
                [
...
modules.append(
    {
        ...
        "sections": [
            section(
                "M14-S1",
                "Phase 1 (2026-2027) — Pilot Treaties & Tooling",
                [
            ...
            section(
                "M14-S2",
                "Phase 2 (2028-2029) — GAISM Observer & GTI v1.0",
                [
            ...
            section(
                "M14-S3",
                "Phase 3 (2030-2032) — Full Treaty Activation",
                [
            ...
            section(
                "M14-S4",
                "Phase 4 (2033-2035) — Maturity & Civilizational Integration",
                [
...
schemas = [
    {
        "id": "civilizationalAxiom",
        "title": "Civilizational Codex Axiom",
        "fields": [
            "id",
            "title",
            "text",
    ...
    {
        "id": "lexaiBundle",
        "title": "LexAI-DSL Bundle",
        "fields": ["hash", "dsl", "signatures[]", "version", "sunset?", "pcbRef?"],
    },
    {
        "id": "lexaiClause",
        "title": "LexAI Clause",
    ...
    {
        "id": "proofArtifact",
        "title": "FV-LexAI Proof Artifact",
        "fields": [
            "propertyId",
            "prover",
            "method (TLA+|Lean|Coq|Z3)",
            "proofRef",
            "verifierSignatures[]",
            "expiry",
        ],
    ...
    {
        "id": "treatyEvent",
        "title": "Treaty Ledger Event (WORM)",
        "fields": [
            "id",
            "type",
            "payload",
    ...
    {
        "id": "gtiRecord",
        "title": "Global Trust Index Record",
        "fields": [
            "institutionId",
            "score",
            "subIndices",
    ...
    {
        "id": "tdlInstrument",
        "title": "Trust Derivative Instrument",
        "fields": [
            "isin",
            "type (TLB|TDS|COS|RES)",
            "issuer",
            "underlyingGTI",
            "trigger",
            "notional",
...
cases = [
    {
        "id": "CS-01",
        "title": "Cross-Border Flash Event (DR-02 drill)",
        "summary": "Three regulators executed a coordinated drill on an AI-driven equity flash event; kill-switch propagated in 47s, capital overlay applied within 3 BD.",
        "outcomes": [
    ...
    {
        "id": "CS-02",
        "title": "Synthetic-Media Bank Run (DR-03 drill)",
        "summary": "Deepfake CEO video coordinated with cryptographically-signed counter-bulletin within 12 minutes; depositor outflows contained.",
        "outcomes": [
    ...
    {
        "id": "CS-03",
        "title": "GAISM Observer AI Stress Test",
        "summary": "EU/UK/US/JP/SG ran the first AI stress test; identified concentrated GTI weakness in two G-SIBs; capital overlay calibration adjusted.",
        "outcomes": [
    ...
    {
        "id": "CS-04",
        "title": "Citizen Deliberation on Generative-Media Disclosure",
        "summary": "Sortition panel of 240 citizens across 12 countries produced consensus recommendations; 7 adopted into LexAI-DSL bundle.",
        "outcomes": [
    ...
    {
        "id": "CS-05",
        "title": "PQC Migration of Treaty Roots",
        "summary": "Treaty Authority migrated to hybrid Ed25519+ML-DSA-65 root; verifier sidecars updated with zero-downtime rollover.",
        "outcomes": [
    ...
    {
        "id": "CS-06",
        "title": "Climate-Finance AI Misalignment Detection",
        "summary": "FV-LexAI property monitor detected systematic mispricing of transition risk; supervisors issued joint guidance and capital overlay.",
        "outcomes": [
...
kpis = [
    {
        "id": "KPI-01",
        "name": "Kill-switch propagation latency (global)",
        "target": "≤ 60 s p95",
    },
    {
        "id": "KPI-02",
        "name": "Cross-border SEV-1 incident reporting",
        "target": "≤ 24 h",
    },
    {
        "id": "KPI-03",
        "name": "FV-LexAI property pass-rate per release",
        "target": "100% on P1-P7",
    },
    {
        "id": "KPI-04",
        "name": "Treaty Ledger daily Merkle anchor success",
        "target": "100%",
    },
    {"id": "KPI-05", "name": "GTI publication freshness", "target": "≤ 7 BD"},
    {
        "id": "KPI-06",
        "name": "Drill participation across regulators",
        "target": "≥ 8 jurisdictions / yr",
    },
    {
        "id": "KPI-07",
        "name": "Deliberation panel sortition representativeness",
        "target": "≥ 0.95 strata fidelity",
    },
    ...
    {
        "id": "KPI-11",
        "name": "AI Capital Overlay calibration freshness",
        "target": "≤ 1 quarter",
    },
    ...
    {
        "id": "KPI-14",
        "name": "Public bulletin signature verification",
        "target": "≥ 99% of recipients",
    },
    {
        "id": "KPI-15",
        "name": "Quantum-safe coverage of trust roots",
        "target": "100% by 2030",
    },
    {
        "id": "KPI-16",
        "name": "Independent-evaluator quorum on GTI",
        "target": "≥ 3 per institution",
    },
    {
        "id": "KPI-17",
        "name": "Disparate-impact bound on financial AI",
        "target": "ε ≤ 0.05",
    },
    ...
    {
        "id": "KPI-20",
        "name": "Deliberation output → LexAI ratification",
        "target": "≥ 60% per cycle",
    },
    ...
    {
        "id": "KPI-24",
        "name": "Maturity tier across G-SIFIs by 2032",
        "target": "≥ T3 median",
    },
]
...
treatyArticles = [
    {
        "id": "GASRGP-04",
        "treaty": "GASRGP",
        "article": "Art 4 Pre-deployment evaluation",
        "summary": "Mandatory pre-deployment evaluation for frontier models above compute threshold.",
        "lexaiClauseRef": "OBL_GASRGP_ART4_EVAL",
    },
    {
        "id": "GASRGP-07",
        "treaty": "GASRGP",
        "article": "Art 7 Cross-border incident reporting",
        "summary": "≤24h SEV-1 reporting across jurisdictions; signed bulletins via Treaty Ledger.",
        "lexaiClauseRef": "OBL_GASRGP_ART7_REPORT",
    },
    {
        "id": "GASRGP-11",
        "treaty": "GASRGP",
        "article": "Art 11 Compute governance",
        "summary": "Licensing for >10^26 FLOP runs; supply-chain auditability.",
        "lexaiClauseRef": "OBL_GASRGP_ART11_COMPUTE",
    },
    {
        "id": "GASRGP-14",
        "treaty": "GASRGP",
        "article": "Art 14 Mutual recognition",
        "summary": "Drills and supervisory attestations recognized across signatories.",
        "lexaiClauseRef": "OBL_GASRGP_ART14_MR",
    },
    {
        "id": "GASRGP-18",
        "treaty": "GASRGP",
        "article": "Art 18 Kill-switch obligations",
        "summary": "Treaty-anchored kill-switch with multisig and ≤60s SLA.",
        "lexaiClauseRef": "OBL_GASRGP_ART18_KS",
    },
    {
        "id": "GASC-02",
        "treaty": "GASC",
        "article": "Art 2 Autonomous lethal force prohibition",
        "summary": "Hard prohibition on autonomous lethal targeting decisions.",
        "lexaiClauseRef": "PRO_GASC_ART2_LETHAL",
    },
    {
        "id": "GASC-05",
        "treaty": "GASC",
        "article": "Art 5 Manipulative cognitive targeting",
        "summary": "Prohibits manipulative AI targeting cognitive vulnerabilities.",
        "lexaiClauseRef": "PRO_GASC_ART5_MANIP",
    },
    {
        "id": "GASC-09",
        "treaty": "GASC",
        "article": "Art 9 Synthetic-media provenance",
        "summary": "Mandatory provenance and disclosure for synthetic media at scale.",
        "lexaiClauseRef": "OBL_GASC_ART9_PROV",
    },
    {
        "id": "GASC-12",
        "treaty": "GASC",
        "article": "Art 12 Inspection rights",
        "summary": "Independent verification rights for AISI and academia.",
        "lexaiClauseRef": "OBL_GASC_ART12_INSPECT",
    },
    {
        "id": "GAISM-CAP",
        "treaty": "GAISM",
        "article": "Capital Overlay Schedule",
        "summary": "AI RWA add-on calibrated to GTI sub-indices.",
        "lexaiClauseRef": "OBL_GAISM_CAP_OVERLAY",
    },
    {
        "id": "GAISM-LIQ",
        "treaty": "GAISM",
        "article": "Liquidity Facility",
        "summary": "24-72 h backstop during AI-induced market stress.",
        "lexaiClauseRef": "OBL_GAISM_LIQ_FACILITY",
    },
    {
        "id": "GAISM-RES",
        "treaty": "GAISM",
        "article": "AI Resolution Authority",
        "summary": "Recovery and resolution tools for AI-coupled failures.",
        "lexaiClauseRef": "OBL_GAISM_RES_AUTHORITY",
    },
]
...
regulators = [
    {
        ...
        "scope": "Eurozone banks, AI Capital Overlay calibration, AI stress test",
        "integrations": [
            "supervisor-gateway-svc",
            "GTI feed",
            "TDL exposure dashboard",
        ],
    },
    {
        "id": "REG-FED",
        "name": "US Federal Reserve",
        "scope": "SR 11-7, AI in bank supervision, TDL CCP coordination",
        "integrations": ["supervisor-gateway-svc", "GTI feed", "Drill orchestration"],
    },
    {
        "id": "REG-PRA",
        "name": "Bank of England — PRA",
        "scope": "SS1/23, model risk, AI stress test",
        "integrations": ["supervisor-gateway-svc", "Drill orchestration"],
    },
    {
        "id": "REG-FCA",
        "name": "Financial Conduct Authority",
        "scope": "Consumer Duty, AI conduct supervision",
        "integrations": ["supervisor-gateway-svc", "Citizen redress integration"],
    },
    {
        "id": "REG-MAS",
        "name": "Monetary Authority of Singapore",
        "scope": "FEAT, AI Verify, sandbox",
        "integrations": ["supervisor-gateway-svc", "AI Verify feeds"],
    },
    {
        "id": "REG-HKMA",
        "name": "Hong Kong Monetary Authority",
        "scope": "GS-1/GL-90, AI in banking",
        "integrations": ["supervisor-gateway-svc"],
    },
    {
        "id": "REG-SEC",
        "name": "US Securities and Exchange Commission",
        "scope": "Broker-dealer/IA AI rules, market AI",
        "integrations": ["supervisor-gateway-svc", "TDL CCP coordination"],
    },
    {
        "id": "REG-FDIC",
        "name": "Federal Deposit Insurance Corporation",
        "scope": "AI guidance, deposit-related AI risks",
        "integrations": ["supervisor-gateway-svc"],
    },
    {
        "id": "REG-IMF",
        "name": "International Monetary Fund",
        "scope": "Article IV surveillance, GAISM administration",
        "integrations": ["GAISM admin", "Country GTI feed"],
    },
    {
        "id": "REG-FSB",
        "name": "Financial Stability Board",
        "scope": "AI vulnerabilities, mutual recognition coordination",
        "integrations": ["GTI heatmap", "Drill mutual recognition"],
    },
    {
        "id": "REG-AISI",
        "name": "AI Safety Institute Network",
        "scope": "Independent verification, red-team battery",
        "integrations": ["FV-LexAI verification", "Audit rights"],
    },
    {
        "id": "REG-OECD",
        "name": "OECD AI Policy Observatory",
        "scope": "Principles alignment, indicator publication",
        "integrations": ["GTI public dashboard input"],
    },
]
...
runbooks = [
    {
        "id": "RB-01",
        "title": "LEVEL-5 containment drill execution",
        "steps": [
            "Convene J-DOC",
    ...
    {
        "id": "RB-02",
        "title": "Treaty bundle hot-swap with multisig",
        "steps": [
    ...
    {
        "id": "RB-03",
        "title": "Cross-border SEV-1 reporting (≤24h)",
        "steps": [
            "Detect",
            "Triage",
            "Sign bulletin",
    ...
    {
        "id": "RB-04",
        "title": "Kill-switch invocation & restoration",
        "steps": [
    ...
    {
        "id": "RB-05",
        "title": "Deliberation panel convening",
        "steps": [
            "Define topic",
            "Sortition sample",
            "3 rounds",
    ...
    {
        "id": "RB-06",
        "title": "GTI re-attestation after evaluator dispute",
        "steps": [
            "Open dispute",
            "Independent re-eval",
            "Quorum sign",
    ...
    {
        "id": "RB-07",
        "title": "TDL circuit-breaker activation",
        "steps": [
...
briefings = [
    {
        ...
        "duration": "15 min / 10 slides",
        "narrativeAnchor": "Codex axioms; civilizational risk; treaty status",
    },
    {
        "id": "BD-02",
        "audience": "Central-Bank Governors",
        "duration": "30 min",
        "narrativeAnchor": "GTI heatmap, GAISM facility status, AI Capital Overlay",
    },
    {
        "id": "BD-03",
        "audience": "IMF / FSB plenary",
        "duration": "45 min",
        "narrativeAnchor": "Country GTI trajectory, TDL exposure, cross-border drills",
    },
    {
        "id": "BD-04",
        "audience": "G-SIFI Board",
        "duration": "60 min",
        "narrativeAnchor": "Adversarial findings, kill-switch drills, capital impact",
    },
    {
        "id": "BD-05",
        "audience": "Parliamentary committee",
        "duration": "60 min",
        "narrativeAnchor": "Rights, contestability, citizen oversight",
    },
    {
        "id": "BD-06",
        "audience": "Public press",
        "duration": "20 min",
        "narrativeAnchor": "Plain language, signed provenance, redress channels",
    },
]
...
traceability = [
    {
        "feature": "M2 LexAI-DSL clauses",
        "control": "Hash-chained machine-readable obligations",
        "regimes": [
            "EU AI Act 2026 (multiple)",
            "ISO/IEC 42001 Cl 8.4",
            "NIST AI RMF Govern 1.4",
        ],
    },
    {
        "feature": "M3 FV-LexAI property suite",
        "control": "Formal proofs of safety/liveness/non-discrimination",
        "regimes": ["EU AI Act Art 9/10", "SR 11-7 III.B", "ISO/IEC 23894"],
    },
    {
        "feature": "M4 GASC Art 2 prohibition",
        "control": "Hard prohibition on autonomous lethal force",
        "regimes": ["GASC Art 2", "UN Charter", "IHL"],
    },
    {
        "feature": "M4 GAISM AI Capital Overlay",
        "control": "RWA add-on tied to GTI",
        "regimes": ["Basel III/IV", "EU CRR", "SR 11-7"],
    },
    {
        "feature": "M5 GTI sub-indices",
        "control": "Multi-evaluator attestations",
        "regimes": ["EU AI Act Art 13", "MAS FEAT", "OECD AI Principles"],
    },
    {
        "feature": "M6 federated drills",
        "control": "Mutual recognition under GASRGP Art 14",
        "regimes": ["GASRGP Art 14", "FSB recommendations"],
    },
    {
        "feature": "M8 deliberation outputs",
        "control": "Citizen recommendations to LexAI",
        "regimes": ["COE AI Convention", "ICCPR Art 25"],
    },
    {
        "feature": "M9 Treaty Ledger",
        "control": "Append-only WORM ledger with Merkle anchors",
        "regimes": ["EU AI Act Art 12", "ISO/IEC 27001 A.12.4"],
    },
    {
        "feature": "M10 PQC hybrid signatures",
        "control": "Quantum-safe trust roots",
        "regimes": ["NIST PQC migration", "BIS PQC guidance"],
    },
    {
        "feature": "M11 sector mapping",
        "control": "Sector-specific obligations",
        "regimes": ["FCRA §615(a)", "FCA Consumer Duty", "Solvency II"],
    },
    {
        "feature": "M12 inspection rights",
        "control": "Independent verification access",
        "regimes": ["GASC Art 12", "AI Safety Institute statutes"],
    },
    {
        "feature": "M13 maturity model",
        "control": "Tiered conformance assessment",
        "regimes": ["ISO/IEC 42001 Annex A", "NIST AI RMF profiles"],
    },
]
...
dataFlows = [
    {
        "id": "DF-01",
        "name": "Bundle → FV-LexAI → Activation",
        "steps": [
        ...
        "controls": ["multisig", "FV gates", "WORM ledger"],
    },
    {
        "id": "DF-02",
        "name": "Decision Envelope → GTI",
        "steps": [
        ...
        "controls": ["evaluator quorum", "tamper-evident chain"],
    },
    {
        "id": "DF-03",
        "name": "Cross-border Incident",
        "steps": [
            "Detect SEV-1",
            "Sign bulletin",
        ...
        "controls": ["≤24h SLA", "PKI verification", "Counter-deepfake"],
    },
    {
        "id": "DF-04",
        "name": "Kill-Switch Propagation",
        "steps": ["Co-sign", "Anycast broadcast", "Sidecars contain", "Verify SLA"],
        "controls": ["multisig", "≤60s SLA", "rollback plan"],
    },
    {
        "id": "DF-05",
        "name": "Deliberation → LexAI",
        "steps": [
            "Sortition",
        ...
        "controls": ["integrity attestation", "anti-manipulation"],
    },
    {
        "id": "DF-06",
        "name": "TDL Trigger",
        ...
        "controls": ["position limits", "CCP supervision"],
    },
]
