...
DOC["schemas"] = [
    ...
    },
    {
        ...
        "fields": ["policyId", "result", "controlId", "regimeRefs", "latencyMs"],
    },
    {
        "id": "attestationEvent",
        "title": "Streaming Attestation",
        "fields": ["attId", "ts", "subject", "claim", "proofType", "ledgerAnchor"],
    },
    {
    ...
    },
    {
        ...
        "fields": ["contractId", "parties", "obligations", "kpiTargets", "expiry"],
    },
    {
        "id": "treatyClause",
    ...
    },
    {
        ...
        "fields": ["systemId", "principleScores", "auditorId", "verdict"],
    },
    {
        "id": "uglConformance",
        "title": "UGL Conformance Score",
        "fields": ["systemId", "axiomScores", "compositeScore", "verifierProof"],
    },
    {
        "id": "codexInscription",
        "title": "MCIGL Codex Inscription",
        "fields": ["inscriptionId", "type", "narrative", "signatures", "merkleRoot"],
    },
    {
        "id": "incident",
...
DOC["opaPolicies"] = [
    {
        ...
        "regimeRefs": ["BCBS 239 §3", "EU AI Act Art 12"],
        "sacil": "P11",
        "ugl": "A2",
    },
    {
        ...
        "regimeRefs": ["NIST SSDF PO.5", "SLSA L3"],
        "sacil": "P11",
        "ugl": "A2",
    },
    {
    ...
    },
    {
        ...
        "regimeRefs": ["EU AI Act Art 11", "ISO/IEC 42001 §7.5"],
        "sacil": "P11",
        "ugl": "A5",
    },
    {
    ...
    },
    {
        ...
        "regimeRefs": ["FCRA §615(a)", "ECOA Reg B"],
        "sacil": "P5",
        "ugl": "A6",
    },
    {
    ...
    },
    {
        ...
        "regimeRefs": ["EU AI Act Art 10", "ECOA"],
        "sacil": "P3",
        "ugl": "A6",
    },
    {
    ...
    },
    {
        ...
        "regimeRefs": ["GDPR Art 22(3)", "EU AI Act Art 13"],
        "sacil": "P11",
        "ugl": "A5",
    },
    {
    ...
    },
    {
        ...
        "regimeRefs": ["UGL A3", "EU AI Act Art 9"],
        "sacil": "P5",
        "ugl": "A3",
    },
]
...
DOC["treatyClauses"] = [
    {
        ...
        "regimes": ["EU AI Act Art 55", "Bletchley/Seoul"],
        "ugl": ["A1", "A9"],
    },
    {
        "id": "TC-02",
        "name": "Catastrophic risk reporting ≤ 72h",
        "regimes": ["EU AI Act Art 55(1)(c)"],
        "ugl": ["A1", "A7"],
    },
    {
        "id": "TC-03",
        "name": "Compute reporting ≥ 10^25 FLOP",
        "regimes": ["US EO 14110", "EU AI Act"],
        "ugl": ["A1", "A2"],
    },
    {
        "id": "TC-06",
        "name": "Human oversight non-derogable",
        "regimes": ["EU AI Act Art 14", "GDPR Art 22"],
        "ugl": ["A1", "A5"],
    },
    {
        "id": "TC-10",
        "name": "Data-protection mutual recognition",
        "regimes": ["GDPR", "Convention 108+"],
        "ugl": ["A2", "A6"],
    },
    {
        "id": "TC-11",
        "name": "Rights-impact assessment",
        "regimes": ["EU AI Act Art 27", "CoE Framework"],
        "ugl": ["A4", "A6"],
    },
]
...
print(
    f"  modules={len(MODULES)} sections={sections} schemas={len(DOC['schemas'])} "
