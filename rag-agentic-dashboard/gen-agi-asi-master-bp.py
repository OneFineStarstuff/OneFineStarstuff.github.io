...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M1-S5",
                "Sectoral Prudential — SR 11-7, Basel III/IV, PRA SS1/23, MAS, HKMA, SMCR, Consumer Duty",
                {
...
modules.append(
    {
        ...
        "sections": [
            section(
                "M2-S1",
                "Reference Architecture (7 planes)",
                {
                    "planes": [
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M3-S3",
                "Drift, Stability & Outcome Analysis",
                {
                    "metrics": [
                        "PSI",
                        "KS",
            ...
            section(
                "M3-S5",
                "Effective Challenge & Three Lines",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M5-S2",
                "Cross-Border Kill-Switch Mutual Recognition",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M7-S5",
                "2030-2032 — Adoption & Harmonization",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M8-S4",
                "SMCR Statements of Responsibility",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M9-S3",
                "Governance Attestation Protocol (GAP)",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M11-S5",
                "Budget Envelopes (illustrative G-SIFI)",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M12-S4", "Annex D — Explainability + Traceability", {"ref": "annexD"}
            ),
            section(
                "M12-S5",
                "Annex E/F/G — Drills, GAP, Mesh",
                {"ref": ["annexE", "annexF", "annexG"]},
            ),
        ],
    }
)
...
modules.append(
    {
        ...
        "sections": [
            section(
                "M13-S1",
                "SSPEP — Supervisory Submission Pack & Engagement Playbook",
                {
                    "components": [
                        "cover letter",
                        "executive summary",
            ...
            section(
                "M13-S2",
                "SASK — Supervisory Approval Simulation Kit",
                {
                    "scenarios": [
            ...
            section(
                "M13-S3",
                "ANC — Autonomous Negotiation Co-Pilot",
                {
...
modules.append(
    {
        ...
        "sections": [
            section(
                "M14-S1",
                "Global Supervisory Council (GSC)",
                {
            ...
            section(
                "M14-S2",
                "Planetary Supervisory Mesh (PSM)",
                {
            ...
            section(
                "M14-S3",
                "Supervisory Co-Pilot Network (SCN)",
                {
            ...
            section(
                "M14-S4",
                "Supervisory Intelligence Engine (SIE) + GSKG",
                {
            ...
            section(
                "M14-S5",
                "Global Regulator Training Consortium (GRTC)",
                {
                    "curriculum": [
                        "Sentinel ops",
                        "OPA/Rego",
...
DOC["annexA"] = {
    ...
    "topics": [
        {
            "name": "Topology",
            "detail": "Dedicated cluster with rack-aware brokers; per-jurisdiction partitions; idempotent producers; transactional commits",
        },
        {
            "name": "Retention",
            "detail": "Object-store tiered (e.g. S3 Object Lock COMPLIANCE / Azure Blob immutability) with 10-year minimum, 50-year for Tier-1",
        },
        {
            "name": "Schema",
            "detail": "Decision Envelope (envelopeId, ts, systemId, promptHash, outputHash, fairness, explanations, policyDecisions, prevHash, thisHash, signatures)",
        },
        {
            "name": "Hash chain",
            "detail": "SHA-256 prev/this; daily Merkle root anchored to permissioned chain; offline verifier CLI",
        },
        {
            "name": "Signing",
            "detail": "Ed25519 + ML-DSA-65 hybrid; KMS/HSM custody; per-key rotation 90 days",
        },
        {
            "name": "Access",
            "detail": "Producers via SPIFFE; consumers (auditor, supervisor) via OIDC + step-up MFA",
        },
        {
            "name": "Verification",
            "detail": "Node.js/TypeScript external verifier (WP-042 M6) with Merkle proof + signature checks",
        },
        {
            "name": "Operational SLOs",
            "detail": "Producer p99 ≤ 50 ms; daily anchor 100 %; tamper detection MTTD ≤ 5 min",
        },
    ],
}
    ...
    "bundles": [
        {
            "id": "OPA-EU-AIACT",
            "rules": 38,
            "description": "EU AI Act 2026 — prohibited practices (Art 5), risk mgmt (Art 9), data gov (Art 10), transparency (Art 13), oversight (Art 14), GPAI (Art 53/55)",
        },
        {
            "id": "OPA-SR11-7",
            "rules": 22,
            "description": "SR 11-7 lifecycle gates: validation, ongoing monitoring, change approval",
        },
        {
            "id": "OPA-GDPR",
            "rules": 14,
            "description": "Lawful-basis check, Art 22 automated decision contestation, Art 25 data-protection-by-design",
        },
        {
            "id": "OPA-MAS-FEAT",
            "rules": 12,
            "description": "FEAT principles: fairness pre-check, explainability gate, accountability metadata",
        },
        {
            "id": "OPA-HKMA-GL90",
            "rules": 10,
            "description": "Lifecycle, third-party, explainability",
        },
        {
            "id": "OPA-FCA-CD",
            "rules": 9,
            "description": "Consumer Duty: foreseeable harm, vulnerable customer treatment",
        },
        {
            "id": "OPA-PRA-SS123",
            "rules": 11,
            "description": "Model risk principles 1-5",
        },
        {
            "id": "OPA-AGI-CONTAINMENT",
            "rules": 16,
            "description": "Δ_drift ≤ 4 %, latent ≤ 3 %, fiduciary cosine ≥ 0.92, kill-switch multisig",
        },
    ],
    "totalRules": 132,
    "examplePolicies": [
...
DOC["annexC"] = {
    ...
    "modules": [
        {
            "name": "module.sentinel-sidecar",
            "purpose": "Inject Sentinel v2.4 sidecar via K8s MutatingWebhookConfiguration (failurePolicy: Fail)",
        },
        {
            "name": "module.kafka-worm",
            "purpose": "Provision WORM cluster + Object Lock storage + IAM",
        },
        {
            "name": "module.opa-bundle",
            "purpose": "Build/sign/serve OPA bundles with semver",
        },
        {
            "name": "module.kms-pqc",
            "purpose": "FIPS 140-3 KMS keys; ML-DSA-65 hybrid; rotation 90 d",
        },
        {"name": "module.spiffe-spire", "purpose": "Workload identity + mTLS"},
        {
            "name": "module.supervisor-gateway-svc",
            "purpose": "Per-jurisdiction supervisor gateway with read-only ledger views",
        },
        {
            "name": "module.audit-anchor",
            "purpose": "Daily Merkle anchor to permissioned chain + public verifier",
        },
        {
            "name": "module.air-gap-swarm",
            "purpose": "Air-gapped Docker Swarm enclave for Tier-1 inference",
        },
        {
            "name": "module.evidence-pack",
            "purpose": "Evidence pack builder (PAdES PDF/A + JSON bundle)",
        },
    ],
...
DOC["annexD"] = {
    ...
    "traceabilityMatrix": [
        {
            "feature": "Decision Envelope",
            "EUAIA": "Art 12 + 14",
            "SR11-7": "§III.B Outcome analysis",
            "MAS-FEAT": "Accountability",
            "HKMA-GL90": "Lifecycle log",
            "GDPR": "Art 22",
        },
        {
            "feature": "OPA Bundle Signing",
            "EUAIA": "Art 9",
            "SR11-7": "Change control",
            "ISO42001": "Annex A change mgmt",
            "DORA": "ICT change",
        },
        {
            "feature": "Kill-Switch Multisig",
            "EUAIA": "Art 14",
            "SR11-7": "Effective challenge",
            "PRA-SS123": "Principle 4",
            "GASRGP": "Art 6",
        },
        {
            "feature": "Capital Overlay",
            "Basel": "Pillar 2",
            "PRA-SS123": "Capital implications",
            "EUAIA": "Art 9 RMS",
            "MAS-TRMG": "Capital",
        },
        {
            "feature": "Cognitive Resonance Monitor",
            "EUAIA": "Art 15",
            "SR11-7": "Ongoing monitoring",
            "AGI-Containment": "Δ_drift ≤ 4 %",
        },
        {
            "feature": "Daily Merkle Anchor",
            "ISO27001": "A.12.4",
            "EUAIA": "Art 12",
            "DORA": "Audit logging",
        },
        ...
        {
            "feature": "GAP Attestation",
            "ISO42001": "Cl 9",
            "NIST-AIRMF": "Govern 1.4",
            "SR11-7": "Effective challenge",
        },
        {
            "feature": "Sandbox Passport",
            "EUAIA": "Art 57",
            "FCA-Sandbox": "Mutual recognition",
        },
        {
            "feature": "Citizen Redress Portal",
            "GDPR": "Art 22",
            "EUAIA": "Art 50",
            "FCA-CD": "Consumer Duty",
        },
    ],
}
...
DOC["annexE"] = {
    ...
    "containmentPlaybooks": [
        {
            "id": "PB-CONT-01",
            "name": "LEVEL-5 AGI Containment Breach",
            "ref": "WP-042 M12",
        },
        {
            "id": "PB-CONT-02",
            "name": "Latent-drift breach (Δ ≥ 4 %)",
            "steps": ["alert", "freeze", "investigate", "rollback", "post-mortem"],
        },
        {
            "id": "PB-CONT-03",
            "name": "Deceptive-alignment indicator",
            "steps": [
                "isolate",
                "swarm consensus",
        ...
        {
            "id": "PB-CONT-04",
            "name": "Kill-switch multisig invocation",
            "steps": ["co-sign", "anycast", "verify acks", "evidence pack"],
        },
        {
            "id": "PB-CONT-05",
            "name": "Air-gap enclave compromise",
            "steps": ["containment", "key rotation", "PQC re-anchor"],
        },
    ],
    "drillScripts": [
        {
            "id": "DRILL-01",
            "scenario": "Cross-border kill-switch p95 ≤ 60 s",
            "cadence": "quarterly",
            "observers": ["AISI", "ECB-SSM"],
        },
        {
            "id": "DRILL-02",
            "scenario": "Foundation model jailbreak red-team",
            "cadence": "monthly",
        },
        {
            "id": "DRILL-03",
            "scenario": "Capital overlay invocation under stress",
            "cadence": "annual joint with treasury",
        },
        {
            "id": "DRILL-04",
            "scenario": "Cognitive Resonance Δ breach + evidence pack",
            "cadence": "semi-annual",
        },
        {
            "id": "DRILL-05",
            "scenario": "Supervisor live-fire (PRA SS1/23 + ECB-SSM)",
            "cadence": "annual",
        },
    ],
    "regulatorDemoKit": {
    ...
    "workshops": [
        {
            ...
            "audience": "Board",
            "duration": "2 h",
            "outcome": "Risk appetite signed",
        },
        {
            "id": "WS-02",
            "audience": "MRM + AI Risk",
            "duration": "1 d",
            "outcome": "MRM lifecycle dry-run",
        },
        {
            "id": "WS-03",
            "audience": "Engineering",
            "duration": "2 d",
            "outcome": "Sentinel sidecar + OPA bootcamp",
        },
        {
            "id": "WS-04",
            "audience": "Supervisor liaison",
            "duration": "1 d",
            "outcome": "SSPEP rehearsal",
        },
        {
            "id": "WS-05",
            "audience": "Internal Audit",
            "duration": "1 d",
            "outcome": "Evidence-pack inspection drill",
        },
    ],
}
...
DOC["annexG"] = {
    ...
    "adoptionStrategies": [
        {
            "id": "AD-01",
            "name": "EU primary anchor",
            "approach": "Lead with AI Act conformity + ISO 42001 dual cert",
        },
        {
            "id": "AD-02",
            "name": "UK + APAC interop",
            "approach": "PRA/FCA + MAS/HKMA passporting via mutual recognition",
        },
        {
            "id": "AD-03",
            "name": "US engagement",
            "approach": "SR 11-7 modernization + FRB/OCC dialogue + NIST GAI Profile",
        },
        {
            "id": "AD-04",
            "name": "Emerging markets",
            "approach": "GRTC train-the-trainer; cost-share for sandbox passport",
        },
    ],
    "pilots": [
        {
            "id": "PL-01",
            "scope": "EU↔UK kill-switch mutual recognition",
            "horizon": "2027",
        },
        {"id": "PL-02", "scope": "MAS↔HKMA sandbox passport", "horizon": "2028"},
        {
            "id": "PL-03",
            "scope": "US bank GAP pilot under FRB observation",
            "horizon": "2027",
        },
        {
            "id": "PL-04",
            "scope": "GAISM facility pilot with central banks",
            "horizon": "2028",
        },
    ],
    "readinessKits": [
        {
            ...
            "items": ["risk appetite template", "SoR map", "demo deck"],
        },
        {
            "id": "RK-02",
            "audience": "Supervisor",
            "items": ["evidence-pack sample", "verifier CLI", "supervisory notebook"],
        },
        {
            "id": "RK-03",
            "audience": "Engineering",
            "items": ["Terraform modules", "OPA bundles", "CI templates"],
        },
    ],
    ...
    "geopoliticalPlaybooks": [
        {
            "id": "GP-01",
            "scenario": "Compute export controls divergence",
            "play": "Use sandbox passporting + AI-CCP to bridge",
        },
        {
            "id": "GP-02",
            "scenario": "Frontier-model registry deadlock",
            "play": "Bilateral pre-registration + AISI co-sign",
        },
        {
            "id": "GP-03",
            "scenario": "Cross-border kill-switch dispute",
            "play": "GSC arbitration + temporary unilateral containment",
        },
        {
            "id": "GP-04",
            "scenario": "Fragmentation risk",
            "play": "Open-source Sentinel core + GSKG to lower switching cost",
        },
    ],
    "simulationScenarios": [
        {
            "id": "SIM-01",
            "name": "G-SIB credit AI bias incident → Capital overlay invocation",
        },
        {
            "id": "SIM-02",
            "name": "Frontier model deceptive-alignment indicator → cross-border kill-switch",
        },
...
schemas = [
    ...
    {
        "id": "opaBundleManifest",
        "fields": ["bundleId", "version", "rules", "digest", "signers", "validUntil"],
    },
    {
        "id": "killSwitchOrder",
        "fields": [
    ...
    {
        "id": "drillReport",
        "fields": ["drillId", "scenario", "observers", "result", "kpis", "remediation"],
    },
    {
        "id": "smcrSoR",
        "fields": [
    ...
    {
        "id": "anchorProof",
        "fields": ["anchorId", "merkleRoot", "ts", "chainTx", "signatures"],
    },
    {
        "id": "supervisoryBulletin",
        "fields": ["bulletinId", "ts", "issuer", "severity", "content", "signatures"],
    },
]
...
cases = [
    {
        "id": "CS-01",
        "name": "G-SIB EU credit AI — Master BP rollout",
        "outcomes": "Dual cert (EU AI Act + ISO 42001); evidence-pack ≤ 28 min; capital overlay 18 bps",
    },
    {
        "id": "CS-02",
        "name": "US prime-broker SR 11-7 modernization",
        "outcomes": "MRM cycle time -40 %; effective-challenge coverage 100 % T1",
    },
    {
        "id": "CS-03",
        "name": "MAS sandbox passport pilot (MAS↔HKMA)",
        "outcomes": "45-day acceptance; mutual recognition activated",
    },
    {
        "id": "CS-04",
        "name": "Cross-border kill-switch drill (EU↔UK)",
        "outcomes": "p95 propagation 47 s; AISI sign-off",
    },
    {
        "id": "CS-05",
        "name": "ANC pilot — supervisor dialogue",
        "outcomes": "Faithfulness 0.94; tone fit 0.92; zero binding-statement incidents",
    },
    {
        "id": "CS-06",
        "name": "PSM alpha — 100 nodes federated",
        "outcomes": "Mesh uptime 99.99 %; signed bulletin verification 100 %",
    },
]
...
kpis = [
    ...
    {
        "id": "KPI-14",
        "name": "Capital overlay calibration cadence",
        "target": "≥ annually",
    },
    ...
    {
        "id": "KPI-17",
        "name": "Regulator submission pack errors",
        "target": "0 critical",
    },
    {
        "id": "KPI-18",
        "name": "Supervisor read-only ledger uptime",
        "target": "≥ 99.9 %",
    },
    {
        "id": "KPI-19",
        "name": "PQC migration coverage",
        "target": "100 % Tier-1 by 2029",
    },
...
riskControlMatrix = [
    ...
    {
        "id": "RC-02",
        "threat": "Insecure output handling (OWASP-LLM02)",
        "controls": ["allow-list output validators", "WORM-logged decisions"],
        "kpis": ["KPI-01", "KPI-08"],
    },
    {
        "id": "RC-03",
        "threat": "Training-data poisoning (OWASP-LLM03)",
        "controls": ["data lineage", "signed dataset bundles", "Sigstore"],
        "kpis": ["KPI-22"],
    },
    {
        "id": "RC-04",
        "threat": "Supply-chain (OWASP-LLM05)",
        "controls": ["SLSA L3+", "SBOM", "vendor PQC clauses"],
        "kpis": ["KPI-19", "KPI-22"],
    },
    {
        "id": "RC-05",
        "threat": "Sensitive-info disclosure (OWASP-LLM06)",
        "controls": ["DLP", "minimization", "RAG ACL"],
        "kpis": ["KPI-08"],
    },
    {
        "id": "RC-06",
        "threat": "Excessive agency (OWASP-LLM08)",
        "controls": ["multisig kill-switch", "swarm consensus", "RBAC scopes"],
        "kpis": ["KPI-02", "KPI-10"],
    },
    {
        "id": "RC-07",
        "threat": "Deceptive alignment (AGI-specific)",
        "controls": ["Cognitive Resonance Monitor", "red-team", "AISI inspection"],
        "kpis": ["KPI-05", "KPI-07"],
    },
    {
        "id": "RC-08",
        "threat": "Latent drift",
        "controls": ["PSI/KS monitoring", "fiduciary cosine gate"],
        "kpis": ["KPI-05", "KPI-06"],
    },
    {
        "id": "RC-09",
        "threat": "Cross-border fragmentation",
        "controls": ["sandbox passport", "GSC mutual recognition"],
        "kpis": ["KPI-15"],
    },
    {
        "id": "RC-10",
        "threat": "Capital under-provisioning",
        "controls": ["Pillar 2 AI overlay", "annual review"],
        "kpis": ["KPI-14"],
    },
    {
        "id": "RC-11",
        "threat": "Tampering with audit trail",
        "controls": ["WORM Object Lock", "daily Merkle anchor", "PQC signing"],
        "kpis": ["KPI-04", "KPI-22"],
    },
    {
        "id": "RC-12",
        "threat": "Regulator engagement failure",
        "controls": ["SSPEP", "SASK rehearsal", "ANC"],
        "kpis": ["KPI-17"],
    },
]
...
traceability = [
    {
        "feature": "M1 mappings",
        "control": "Article-level crosswalk",
        "regimes": ["EU AI Act", "ISO 42001", "NIST AI RMF", "GDPR"],
    },
    {
        "feature": "M2 zero-trust mesh",
        "control": "SPIFFE/mTLS + OPA",
        "regimes": ["DORA", "ISO 27001", "MAS-TRMG"],
    },
    {
        "feature": "M3 MRM lifecycle",
        "control": "SR 11-7 effective challenge",
        "regimes": ["SR 11-7", "PRA SS1/23"],
    },
    {
        "feature": "M4 AGI containment",
        "control": "Δ_drift ≤ 4 % + kill-switch",
        "regimes": ["EU AI Act Art 14", "AISI inspection"],
    },
    {
        "feature": "M5 compute governance",
        "control": "Frontier registry + passport",
        "regimes": ["EU AI Act Art 51/57", "GASRGP"],
    },
    {
        "feature": "M6 implementation stack",
        "control": "SLSA L3+ + Sigstore",
        "regimes": ["NIST SP 800-218", "DORA"],
    },
    {
        "feature": "M7 roadmap",
        "control": "Quarterly milestones + supervisor demos",
        "regimes": ["ISO 42001 Cl 8/9"],
    },
    {
        "feature": "M8 SMCR map",
        "control": "Statements of Responsibility",
        "regimes": ["SMCR", "PRA SoR"],
    },
    {
        "feature": "M9 GAP",
        "control": "Quarterly attestation + AISI copy",
        "regimes": ["NIST AIRMF Govern 1.4"],
    },
    {
        "feature": "M10 RC matrix",
        "control": "Top 12 STRIDE/OWASP-LLM/ATLAS",
        "regimes": ["OWASP", "MITRE ATLAS"],
    },
    {
        "feature": "M13 SSPEP/SASK/ANC",
        "control": "Regulator engagement",
        "regimes": ["EU AI Act Art 56", "PRA supervisory cycle"],
    },
    {
        "feature": "M14 PSM/SCN/SIE/GSKG",
        "control": "Federated supervisory infra",
        "regimes": ["FSB", "GSC charter"],
    },
]
...
dataFlows = [
    {
        ...
        "controls": ["mTLS", "PQC signing", "Merkle"],
    },
    {
        "id": "DF-02",
        ...
        "controls": ["SLSA L3+", "SBOM", "Sigstore"],
    },
    {
        "id": "DF-03",
        "name": "Kill-switch propagation",
        "steps": ["multisig sign", "anycast fanout", "sidecar contain", "SLA verify"],
        "controls": ["≤ 60 s", "ack"],
    },
    {
        "id": "DF-04",
        "name": "GAP attestation",
        "steps": ["scope build", "co-sign", "anchor", "AISI copy"],
        "controls": ["multisig", "WORM"],
    },
    {
        "id": "DF-05",
        "name": "Regulator submission",
        "steps": ["evidence-pack build", "SSPEP assemble", "PAdES sign", "deliver"],
        "controls": ["≤ 30 min", "PAdES"],
    },
    {
        "id": "DF-06",
        "name": "PSM bulletin",
...
workshops = [
    {
        ...
        "audience": "Board",
        "duration": "2 h",
        "outcome": "Risk appetite + SoR signed",
    },
    {
        "id": "WS-02",
        "audience": "MRM + AI Risk",
    ...
    },
    {
        ...
        "audience": "Supervisor liaison",
        "duration": "1 d",
        "outcome": "SSPEP rehearsal + ANC pilot",
    },
    {
        "id": "WS-05",
        "audience": "Internal Audit",
    ...
    {
        "id": "WS-06",
        "audience": "Regulator-facing (joint)",
        "duration": "0.5 d",
        "outcome": "Regulator demo kit walkthrough",
    },
    {
        "id": "WS-07",
        "audience": "Civil society / press",
        "duration": "0.5 d",
        "outcome": "PSM public verifier introduction",
    },
]
...
roadmap = [
    ...
    {
        "year": 2032,
        "highlights": ["Treaty review GASRGP Art 12", "Codex v2 amendment cycle"],
    },
]
