...
SRC = ROOT / "data" / "cegl-lexai-gov.json"
OUT = ROOT / "public" / "cegl-lexai-gov.html"
...
<nav>
  ...
  <a href="#kpis">KPIs</a>
  <a href="#treaties">Treaty Articles</a>
...
<section class='block' id='treaties'>
  <h2>Treaty Articles ({len(D['treatyArticles'])})</h2>
  <table><thead><tr><th>ID</th><th>Treaty</th><th>Article</th><th>Summary</th><th>LexAI Clause</th></tr></thead><tbody>{treaty_rows}</tbody></table>
</section>

<section class='block' id='regulators'>
  <h2>Regulator Integrations ({len(D['regulators'])})</h2>
  <table><thead><tr><th>ID</th><th>Name</th><th>Scope</th><th>Integrations</th></tr></thead><tbody>{reg_rows}</tbody></table>
</section>

<section class='block' id='runbooks'>
  <h2>Runbooks ({len(D['runbooks'])})</h2>
  <table><thead><tr><th>ID</th><th>Title</th><th>Steps</th></tr></thead><tbody>{rb_rows}</tbody></table>
</section>

<section class='block' id='briefings'>
  <h2>Briefing Decks ({len(D['briefings'])})</h2>
  <table><thead><tr><th>ID</th><th>Audience</th><th>Duration</th><th>Narrative Anchor</th></tr></thead><tbody>{bd_rows}</tbody></table>
</section>
