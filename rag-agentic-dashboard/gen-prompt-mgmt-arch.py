...
modules.append(
    {
        ...
        "sections": [
            section(
                "M2-S1",
                "Prompt Template Schema (canonical)",
                {
                    "fields": [
                        "id",
                        "tenantId",
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M3-S2",
                "Suggestion Mode & Review Workflow",
                [
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M6-S3",
                "Evaluation Gates (pre-promotion)",
                [
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M7-S2",
                "Policy-as-Code (OPA/Rego sketch)",
                {
...
modules.append(
    {
        ...
        "sections": [
            ...
            section(
                "M14-S4",
                "Compliance Traceability (excerpt)",
                [
...
schemas = [
    ...
    },
    {
        "id": "rbacRole",
        "title": "RBAC Role",
        "fields": ["id", "name", "scopes[]", "constraints", "elevatable"],
    },
    {
        "id": "secretAlias",
...
rbacRoles = [
    {
        "id": "ROLE-01",
        "name": "viewer",
        "scopes": ["prompt:read", "report:read"],
    ...
    },
    {
        "id": "ROLE-02",
        "name": "engineer",
        "scopes": ["prompt:write", "prompt:run", "report:write"],
    ...
    },
    {
        "id": "ROLE-03",
        "name": "reviewer",
        "scopes": ["prompt:review", "comment:write"],
    ...
    },
    {
        "id": "ROLE-05",
        "name": "model_steward",
        "scopes": ["model:bind", "model:deploy", "model:rollback"],
    ...
    },
    {
        "id": "ROLE-06",
        "name": "secrets_admin",
        "scopes": ["secret:create", "secret:rotate", "secret:revoke"],
    ...
    },
    {
        "id": "ROLE-08",
        "name": "auditor",
        "scopes": ["audit:read", "evidence:export"],
    ...
    },
    {
        "id": "ROLE-09",
        "name": "ai_safety_lead",
        "scopes": ["killswitch:invoke", "policy:override"],
...
dataFlows = [
    {
        ...
        "controls": ["lint M2-S4", "sanitize M11-S1", "RBAC M7", "audit M9"],
    },
    {
        "id": "DF-02",
        "name": "Run Prompt",
        ...
        "controls": ["OPA gate", "PII redaction", "rate limit", "tracing"],
    },
    {
        "id": "DF-03",
        "name": "Publish Report",
        ...
        "controls": ["sanitize", "two-eyes", "PDF/UA", "Merkle anchor"],
    },
    {
        "id": "DF-04",
        ...
        "controls": ["read-only role", "no decrypt of raw PII", "signed manifest"],
    },
    {
        "id": "DF-05",
        "name": "Login + Step-up",
        ...
        "controls": ["WebAuthn", "device posture", "SameSite=Strict cookies"],
    },
    {
        "id": "DF-06",
        "name": "Kill-Switch",
        ...
        "controls": ["multisig", "WORM", "SLA ≤60s"],
    },
]
