...
<header class="hero">
  ...
  <div class="badges">
    ...
    <span class="badge warn">EU AI Act Art. 5</span>
    <span class="badge warn">GDPR / UK GDPR</span>
    <span class="badge">NIST AI RMF 1.0</span>
    <span class="badge">ISO/IEC 42001</span>
    <span class="badge ok">SOC 2 Type II</span>
    <span class="badge ok">OWASP LLM Top 10</span>
  </div>
  <div class="kpis">
    ...
    <div class="kpi"><div class="v">7</div><div class="l">Architecture Planes</div></div>
    <div class="kpi"><div class="v">9</div><div class="l">Data Models</div></div>
    <div class="kpi"><div class="v">8</div><div class="l">Data Flows</div></div>
...
<main>
  ...
  <section class="module" id="schemas">
    <h2>JSON Schemas</h2>
    <p class="summary">{n_schemas} schemas covering prompt templates, model registrations, RAG / Gemini envelopes, feedback events, recommendations, evidence, and incidents.</p>
    {schemas_html}
  </section>

  <section class="module" id="code-examples">
    <h2>Code Examples</h2>
    <p class="summary">{n_code} reference implementations: GeminiService gateway, RAG chat, model registry, prompt CRDT collab, active learning, OPA gate, Art. 5 classifier, PII redactor, Merkle audit, CI/CD, adaptive UX hook, signed Kafka producer.</p>
    {code_html}
  </section>

  <section class="module" id="case-studies">
    <h2>Case Studies</h2>
    <p class="summary">{n_cs} reference deployments across banking, life sciences, public sector, insurance, and technology.</p>
    {cs_html}
  </section>
