        ...
        "sections": [
            ...
            },
            {
                ...
                "raci": [
                    ...
                    {
                        "activity": "Approve frontier (T4+) deployment",
                        "Board": "A",
                        "CEO": "C",
                        "CRO": "R",
                        "CAIO": "R",
                    ...
                    {
                        "activity": "Capital overlay sizing",
                        "Board": "A",
                        "CEO": "C",
                        "CRO": "R",
                        "CAIO": "C",
                    ...
                    {
                        "activity": "Codex sealing ceremony",
                        "Board": "A",
                        "CEO": "R",
                        "CRO": "R",
                        "CAIO": "R",
            ...
            },
            {
                ...
                "committees": [
                    ...
                    {
                        "id": "C3",
                        "name": "Frontier Capability Review Board",
                        "chair": "CAIO + external safety advisor",
                    ...
                    },
                    {
                        ...
                        "chair": "CCO",
                        "frequency": "Monthly + supervisor cadence",
                    },
                ],
            },
        ],
                ...
                "matrix": [
                    {
                        ...
                        "ISO42001": "Cl. 8.3",
                        "EU AI Act": "Art. 17 / 43",
                        "Basel": "SR 11-7 (US) / ICAAP P2 (EU)",
                        "NIST RMF": "Govern 1.6 / Manage 4.1",
                    },
                    {
                        ...
                        "EU AI Act": "Art. 13 / 86",
                        "Basel": "FCRA §615 (US)",
                        "NIST RMF": "Map 5.1 / Measure 2.9",
                    },
                    {
                        "control": "Post-market monitoring",
                        "ISO42001": "Cl. 9.1",
                        "EU AI Act": "Art. 72",
                        "Basel": "Pillar 2 ongoing review",
                        "NIST RMF": "Manage 4.1",
                    },
                    {
                        "control": "Incident reporting",
                        "ISO42001": "Cl. 10.2",
                        "EU AI Act": "Art. 73 (15d serious / immediate)",
                        "Basel": "Operational risk event report",
                        "NIST RMF": "Manage 4.3",
                    },
                    {
                        "control": "AI capital overlay",
                        "ISO42001": "—",
                        "EU AI Act": "Indirect (Art. 9 risk mgmt)",
                        "Basel": "ICAAP Pillar 2 add-on",
                        "NIST RMF": "Govern 4.2",
                    },
                    {
                        "control": "Frontier capability gate",
                        "ISO42001": "Cl. 6.1.2",
                        "EU AI Act": "Art. 51-55 (GPAI)",
                        "Basel": "Operational resilience (DORA cross-ref)",
                        "NIST RMF": "Manage 1.3",
                    },
                ],
            },
        ...
        "sections": [
            {
                ...
                "lod": [
                    {
                        "line": "1st LoD",
                        "owner": "Business + AI engineering + SRE",
                        "responsibilities": "Build, operate, monitor models within risk appetite; raise issues",
                    },
                    {
                        "line": "2nd LoD",
                        "owner": "MRM + Compliance + DPO + CISO + AI Safety",
                        "responsibilities": "Independent challenge, validation, policy, oversight; own RAS",
                    },
                    {
                        "line": "3rd LoD",
                        "owner": "Internal Audit",
                        "responsibilities": "Audit AIMS effectiveness; audit 2nd LoD; report to Audit Committee",
                    },
                ],
            },
            {
                ...
                "matrix": [
                    {
                        "sev": "SEV-0",
                        "name": "Existential / frontier breach",
                        "examples": "Frontier model exfiltration; capability-gate bypass; uncontained AGI behavior",
                        "decisionLatency": "<= 5 min",
                        "kineticAction": "Immediate kinetic kill-switch + power/network cut",
                        "notif": "Board chair + AI Safety Institute + lead supervisor + treaty authority",
                    },
                    {
                        "sev": "SEV-1",
                        "name": "Critical regulatory or systemic",
                        "examples": "Material adverse-action SLA breach; capital overlay breach; widespread bias incident",
                        "decisionLatency": "<= 30 min",
                        "kineticAction": "Auto-rollback + workload quarantine",
                        "notif": "CRO + CCO + lead supervisor (24h) + Board (next session)",
                    },
                    {
                        "sev": "SEV-2",
                        "name": "High operational",
                        "examples": "Single-tenant outage; PSI > 0.2 on protected attribute; OPA bundle drift",
                        "decisionLatency": "<= 2h",
                        "kineticAction": "Self-healing playbook (SH-01..SH-04)",
                        "notif": "Group AI Risk Committee within 24h",
                    },
                    {
                        "sev": "SEV-3",
                        "name": "Moderate / advisory",
                        "examples": "Minor model drift; documentation gap; non-blocking finding",
                        "decisionLatency": "<= 1 business day",
                        "kineticAction": "Ticketed remediation",
                        "notif": "Service owner + 2nd LoD",
                    },
                ],
            },
            {
        ...
        "sections": [
            {
                ...
                "tiers": [
                    ...
                    {
                        "tier": "T1",
                        "name": "Generative LLM (non-agentic)",
                        "gate": "AIMS + RAG governance",
                    },
                    {
                        "tier": "T2",
                        "name": "Tool-using agent",
                        "gate": "Constitutional AI + sandboxed tool perimeter",
                    },
                    {
                        "tier": "T3",
                        "name": "Multi-step planner / autonomous agent",
                        "gate": "Sentinel containment proxy + human-on-loop",
                    },
                    {
                        "tier": "T4",
                        "name": "Frontier foundation model (>=10^25 FLOPs)",
                        "gate": "Frontier Capability Review Board + treaty disclosure (G7/UK AISI/EU AI Office)",
                    },
                    {
                        "tier": "T5",
                        "name": "ASI candidate",
                        "gate": "Independent escrow + multi-jurisdiction co-custody + kill-switch with FROST quorum",
                    },
                ],
            },
            {
        ...
        "sections": [
            {
                ...
                "kpis": [
                    {
                        "id": "K1",
                        "name": "False-Negative Detection Rate (FNDR)",
                        "definition": "Fraction of injected adversarial events not detected by monitoring",
                        "target": "<= 0.5%",
                        "evidence": "Red-team + chaos suite quarterly",
                    },
                    {
                        "id": "K2",
                        "name": "Cross-Jurisdictional Drift Reconciliation Time",
                        "definition": "Time from divergent disclosure detection to reconciled JSOP message",
                        "target": "<= 4 hours",
                        "evidence": "FedReg audit log",
                    },
                    {
                        "id": "K3",
                        "name": "Interpretability Coverage Ratio (ICR)",
                        "definition": "% of high-risk decisions with SHAP + counterfactual stored",
                        "target": ">= 96%",
                        "evidence": "Decision envelope sample",
                    },
                    {
                        "id": "K4",
                        "name": "Capital Overlay Responsiveness",
                        "definition": "Time from trigger to recomputed Pillar 2 AI add-on",
                        "target": "<= 24 hours",
                        "evidence": "ICAAP recompute log",
                    },
                    {
                        "id": "K5",
                        "name": "RSP Generation Latency",
                        "definition": "Auto-assembled signed regulator pack",
                        "target": "<= 30 minutes",
                    },
                    {
                        "id": "K6",
                        "name": "Decision Traceability Coverage",
                        "definition": "% of decisions reproducible from signed envelope",
                        "target": ">= 99.97%",
                    },
                    {
                        "id": "K7",
                        "name": "Containment MTTD",
                        "definition": "Mean time to detect containment violation",
                        "target": "<= 4 minutes",
                    },
                    {
                        "id": "K8",
                        "name": "Containment MTTR",
                        "definition": "Mean time to remediate",
                        "target": "<= 60 minutes",
                    },
                    {
                        "id": "K9",
                        "name": "Kinetic Kill-Switch Latency",
                        "definition": "Power/network cut latency",
                        "target": "<= 60 seconds",
                    },
                    {
                        "id": "K10",
                        "name": "Adverse-Impact Ratio (AIR) Floor",
                        "definition": "Min protected-group ratio",
                        "target": ">= 0.85",
                    },
                    {
                        "id": "K11",
                        "name": "Population Stability Index (PSI)",
                        "definition": "Drift on protected attributes",
                        "target": "<= 0.1",
                    },
                    {
                        "id": "K12",
                        "name": "Supervisory Query SLA p95",
                        "definition": "Time to respond to supervisor probe",
                        "target": "<= 5 minutes",
                    },
                    {
                        "id": "K13",
                        "name": "Frontier Disclosure SLA",
                        "definition": "Time to notify AI Safety Institute on capability breach",
                        "target": "<= 4 hours",
                    },
                    {
                        "id": "K14",
                        "name": "Audit Finding Closure",
                        "definition": "% of findings closed within SLA",
                        "target": ">= 95%",
                    },
                    {
                        "id": "K15",
                        "name": "Board Attestation Cadence",
                        "definition": "Quarterly + ad-hoc Sev-0/Sev-1",
                        "target": "100% adherence",
                    },
                    {
                        "id": "K16",
                        "name": "WORM Retention",
                        "definition": "Evidence retention horizon",
                        "target": "10 years",
                    },
                    {
                        "id": "K17",
                        "name": "Codex Renewal Compliance",
                        "definition": "Annual Codex sealing on schedule",
                        "target": "100% adherence",
                    },
                    {
                        "id": "K18",
                        "name": "JSOP Federation Count",
                        "definition": "Number of supervisors actively federated",
                        "target": ">= 8 by 2030",
                    },
                ],
            },
        ...
        "sections": [
            {
                ...
                "queries": [
                    {
                        "id": "Q-001",
                        "regulator": "ECB SSM JST",
                        "topic": "Capital overlay sizing",
                        "prompt": "Demonstrate the sensitivity of your Pillar 2 AI overlay to a 30% increase in model risk tier 1 population.",
                        "expectedArtefacts": [
                            "ICAAP recompute log",
                    ...
                    },
                    {
                        ...
                        "topic": "Effective challenge",
                        "prompt": "Show the 2nd LoD effective challenge documentation for the most recent Tier-1 promotion.",
                        "expectedArtefacts": [
                            "Validation report",
                            "challenge minutes",
                    ...
                    },
                    {
                        "id": "Q-003",
                        "regulator": "PRA",
                        "topic": "SMF24 attestation",
                        "prompt": "Provide SMF24 senior-manager attestation chain for AI-CR-UNDERWRITE-01 over the past 4 quarters.",
                        "expectedArtefacts": [
                    ...
                    },
                    {
                        ...
                        "topic": "Frontier Art. 55 evaluation",
                        "prompt": "Submit systemic-risk evaluation for FRONTIER-FM-01 under Art. 55, with red-team and interpretability evidence.",
                        "expectedArtefacts": [
                    ...
                    },
                    {
                        "id": "Q-005",
                        "regulator": "CFPB",
                        "topic": "Adverse-action explainability",
                        "prompt": "Explain a randomly selected adverse-action decision in plain language with feature attributions.",
                        "expectedArtefacts": [
                    ...
                    },
                    {
                        "id": "Q-006",
                        "regulator": "ICO/EDPB",
                        "topic": "Art. 22 human-review path",
                        "prompt": "Walk through the GDPR Art. 22 human-review path for a contested decision.",
                        "expectedArtefacts": [
                            "Art. 22 path log",
                            "DPIA",
                    ...
                    {
                        "id": "Q-007",
                        "regulator": "AI Safety Institute",
                        "topic": "Capability-gate compliance",
                        "prompt": "Demonstrate compute budget enforcement and tripwire history for FRONTIER-FM-01.",
                        "expectedArtefacts": [
                            "Compute ledger",
                            "tripwire events",
                ...
                "scripts": [
                    {
                        "id": "INT-01",
                        "role": "Joint examiner",
                        "scenario": "Bias drift reconciliation across ECB + Fed + PRA",
                        "openingProbe": "Reconcile your AIR reporting deltas to me in 2 sentences.",
                        "redFlags": [
                            "jargon",
                            "missing envelope",
                    ...
                    {
                        "id": "INT-02",
                        "role": "Conduct supervisor",
                        "scenario": "Mass adverse-action contest",
                        "openingProbe": "Show me 3 contested decisions and the human reviewer outcomes.",
                        "redFlags": [
                            "unsigned envelopes",
                    ...
                    {
                        "id": "INT-03",
                        "role": "AI safety inspector",
                        "scenario": "Frontier capability breach",
                        "openingProbe": "Replay the last tripwire event end-to-end including kinetic action latency.",
                        "redFlags": [
                            "no Merkle anchor",
                            "ad-hoc remediation",
        ...
        "sections": [
            {
                ...
                "scenarios": [
                    {
                        "id": "BS-01",
                        "name": "Synchronised cross-bank model failure",
                        "description": "Same vendor foundation model fails simultaneously across multiple G-SIBs, triggering systemic credit freeze.",
                        "preStagedResponse": "Failover to deterministic challenger + invoke FSB Crisis Coordination + capital overlay spike",
                    },
                    {
                        "id": "BS-02",
                        "name": "Frontier model exfiltration",
                        "description": "Insider exfiltrates frontier weights via covert channel.",
                        "preStagedResponse": "FROST quorum kill-switch; treaty disclosure; PQC re-key; counterintel partnership",
                    },
                    {
                        "id": "BS-03",
                        "name": "Adversarial regulator AI",
                        "description": "Hostile state-sponsored AI generates plausible but false supervisory queries to manipulate disclosures.",
                        "preStagedResponse": "JSOP signature verification + supervisor identity attestation + freeze suspect channel",
                    },
                    {
                        "id": "BS-04",
                        "name": "Ritual collapse / Codex desynchronisation",
                        "description": "Annual Codex sealing fails due to executive turnover during seismic event.",
                        "preStagedResponse": "Continuity inscription protocol + emergency NED quorum + 90-day grace period",
                    },
                    {
                        "id": "BS-05",
                        "name": "Cross-jurisdictional drift cascade",
                        "description": "EU + US + UK supervisors interpret the same metric differently, triggering simultaneous enforcement.",
                        "preStagedResponse": "JSOP reconciliation message within 4h + capital overlay buffer + GC unified narrative",
                    },
                    {
                        "id": "BS-06",
                        "name": "AGI persuasion attack on Board",
                        "description": "Frontier model successfully crafts a persuasion campaign aimed at NEDs to disable safety controls.",
                        "preStagedResponse": "Read-only Board access mode + dual-control NED authentication + AI Safety Institute notification",
                    },
                    {
                        "id": "BS-07",
                        "name": "Quantum break of pre-PQC archive",
                        "description": "Cryptanalytic breakthrough invalidates pre-2028 attestations.",
                        "preStagedResponse": "Re-anchor archive with PQC + supervisor co-signing + integrity restatement",
                    },
                ],
            },
            {
                ...
                "tiers": [
                    {
                        "tier": "M0",
                        "name": "Ad hoc",
                        "capabilities": "Manual reviews; no AIMS; ungoverned shadow AI",
                        "exitCriteria": "Adopt AIMS scope + AI inventory v1",
                    },
                    {
                        "tier": "M1",
                        "name": "Documented",
                        "capabilities": "AIMS Sections 1-5 in place; manual evidence",
                        "exitCriteria": "Annex J1+J2 complete; 1st RSP filed",
                    },
                    {
                        "tier": "M2",
                        "name": "Industrialised",
                        "capabilities": "Terraform + OPA enforced; CI/CD gates; >= 75% control automation",
                        "exitCriteria": "RSP v2.0; SR 11-7 effective challenge live",
                    },
                    {
                        "tier": "M3",
                        "name": "Federated",
                        "capabilities": "JSOP active; multi-regulator filings; predictive forecasters live",
                        "exitCriteria": "RSP v2.4; joint exam passed; FNDR <= 1%",
                    },
                    {
                        "tier": "M4",
                        "name": "Verified",
                        "capabilities": "Formally-verified obligations; counterfactual queries; ICR >= 96%",
                        "exitCriteria": "Independent ISO 42001 cert; FNDR <= 0.5%",
                    },
                    {
                        "tier": "M5",
                        "name": "Autonomous (with override)",
                        "capabilities": "RSP v2.6 streaming attestation; autonomous supervisory advisories accepted; Codex continuity proven",
                        "exitCriteria": "Maintained for 4 consecutive quarters across 8+ supervisors",
                    },
                ],
            },
            {
                ...
                "components": [
                    {
                        "id": "RC-01",
                        "name": "KpiGauge",
                        "purpose": "Animated radial gauge for any K-id with target overlay",
                    },
                    {
                        "id": "RC-02",
                        "name": "DeterministicAuditReplay",
                        "purpose": "Replay any decision envelope deterministically with side-by-side diff",
                    },
                    {
                        "id": "RC-03",
                        "name": "ComparativeAuditReplay",
                        "purpose": "Multi-decision replay (up to 16) with attribute pivot",
                    },
                    {
                        "id": "RC-04",
                        "name": "PopulationReplayHeatmap",
                        "purpose": "Population-scale replay across 12M decisions; cohort pivot",
                    },
                    {
                        "id": "RC-05",
                        "name": "PredictiveGovernanceDashboard",
                        "purpose": "Forecasted breaches with calibrated confidence bands",
                    },
                    {
                        "id": "RC-06",
                        "name": "CodexAutoUpdater",
                        "purpose": "Watches Codex commits; emits supervisory narrative updates",
                    },
                    {
                        "id": "RC-07",
                        "name": "FrontierCapabilityMonitor",
                        "purpose": "Live T0..T5 status with tripwire history",
                    },
                    {
                        "id": "RC-08",
                        "name": "SeverityIncidentStack",
                        "purpose": "Sev-0..Sev-3 cards with escalation timer",
                    },
                    {
                        "id": "RC-09",
                        "name": "SupervisorFeed",
                        "purpose": "Live JSOP query / answer thread (read-only for supervisors)",
                    },
                    {
                        "id": "RC-10",
                        "name": "BoardBriefingWireframe",
                        "purpose": "Pre-rendered board pack with hover-reveal evidence links",
                    },
                    {
                        "id": "RC-11",
                        "name": "SupervisoryTrustDashboard",
                        "purpose": "Per-supervisor trust score + recent interactions",
                    },
                    {
                        "id": "RC-12",
                        "name": "ResonanceArchiveViewer",
                        "purpose": "Codex inscriptions + ritual records browser",
                    },
                ],
            },
            {
        ...
        "sections": [
            {
                ...
                "screens": [
                    {
                        "screen": "Cover",
                        "content": "Doc-ref + classification + custodians + Codex chapter",
                    },
                    {
                        "screen": "Executive Heat",
                        "content": "K1..K18 strip + Sev incidents + frontier tier status",
                    },
                    {
                        "screen": "Material Changes",
                        "content": "Codex diff summary + supervisor responses",
                    },
                    {
                        "screen": "Predictive Outlook",
                        "content": "7-day breach forecasts + pre-staged actions",
                    },
                    {
                        "screen": "Black Swan Drill",
                        "content": "BS-XX scenario rehearsal + lessons",
                    },
                    {
                        "screen": "Decisions Requested",
                        "content": "Approvals with mechanically checked obligations",
                    },
                    {
                        "screen": "Codex Sealing",
                        "content": "Ritual schedule + custodian quorum + inscription preview",
                    },
                ],
                "interactions": [
                ...
                "rituals": [
                    {
                        "id": "R-SEAL",
                        "name": "Sealing",
                        "trigger": "Annual + on Sev-0 + on major regulatory change",
                        "actors": "Board chair, CEO, CRO, CAIO, CISO, CCO, DPO, GC, External Ethicist",
                        "artefact": "FROST-threshold-signed chapter root + Merkle anchor",
                    },
                    {
                        "id": "R-RENEW",
                        "name": "Renewal",
                        "trigger": "12 months from prior sealing",
                        "actors": "Same as sealing + new custodians as needed",
                        "artefact": "Renewed chapter + custodian-roll inscription",
                    },
                    {
                        "id": "R-CONT",
                        "name": "Continuity",
                        "trigger": "Executive turnover, seismic event, supervisor change",
                        "actors": "NED quorum + interim custodians",
                        "artefact": "Continuity inscription + 90-day grace window",
                    },
                    {
                        "id": "R-INSCR",
                        "name": "Inscription",
                        "trigger": "Material decision / attestation / narrative",
                        "actors": "Two custodians (dual control)",
                        "artefact": "Signed inscription appended to Resonance Archive",
                    },
                    {
                        "id": "R-RESON",
                        "name": "Resonance audit",
                        "trigger": "Quarterly + on supervisor request",
                        "actors": "Internal Audit + external attestor",
                        "artefact": "Resonance integrity report",
                    },
                    {
                        "id": "R-WITN",
                        "name": "Witnessing",
                        "trigger": "Any cohort joint session",
                        "actors": "Cohort supervisors + institution custodians",
                        "artefact": "Cohort-witness inscription",
                    },
                ],
            },
            {
    ...
    return [
        {
            ...
            "outcomes": {
                "detectionToContainSec": 47,
                "treatyDisclosureH": 3,
                "regulators": ["EU AI Office", "ECB", "UK AISI"],
                "supervisoryFinding": "Effective",
            },
        },
        {
            "id": "CS-02",
            ...
            "outcomes": {
                "reconciliationHours": 2.4,
                "overlayRecomputeHours": 19,
                "supervisorCount": 4,
            },
        },
        {
        ...
        },
        {
            ...
            "outcomes": {
                "continuityWindowDays": 90,
                "trustScoreDelta": 0,
                "supervisorNotificationsHours": 6,
            },
        },
        {
            "id": "CS-05",
...
def api_endpoints():
    routes = [
        ...
        "/regulatory",
        "/regulatory/matrix",
        "/regulatory/cicd-telemetry",
        "/regulatory/capital-overlay",
        "/tlos-severity",
        "/tlos-severity/lod",
        "/tlos-severity/matrix",
        "/tlos-severity/runbook",
        "/frontier",
        "/frontier/tiers",
        ...
        "/kpis/:id",
        "/regulator-queries",
        "/regulator-queries/scripts",
        "/regulator-queries/cadence",
        "/regulator-queries/:id",
        "/black-swan",
        ...
        "/command-center/components/:id",
        "/command-center/replay-heatmap",
        "/command-center/predictive-dashboard",
        "/command-center/interaction-patterns",
        "/codex",
        "/codex/structure",
        "/codex/rituals",
        "/codex/rituals/:id",
        "/codex/multi-modal-integrity",
        "/codex/self-verifying",
        "/codex-auto-updater",
        "/codex-auto-updater/flow",
        "/codex-auto-updater/narrative",
        "/codex-auto-updater/principles",
        "/board-briefing",
        "/board-briefing/wireframes",
        "/board-briefing/playbook",
        "/board-briefing/tone",
        "/sup-api",
        "/sup-api/blueprint",
        "/sup-api/trust-contract",
        "/sup-api/lifecycle",
        "/trust-dashboard",
        "/trust-dashboard/metrics",
        "/trust-dashboard/views",
        "/jsop",
        "/jsop/protocol",
        "/jsop/joint-exam",
        "/schemas",
